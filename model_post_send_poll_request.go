...
// checks if the PostSendPollRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostSendPollRequest{}

// PostSendPollRequest struct for PostSendPollRequest
type PostSendPollRequest struct {
...
type _PostSendPollRequest PostSendPollRequest
...
func (o PostSendPollRequest) MarshalJSON() ([]byte, error) {
...
func (o PostSendPollRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PostSendPollRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPostSendPollRequest := _PostSendPollRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPostSendPollRequest)

	if err != nil {
		return err
	}

	*o = PostSendPollRequest(varPostSendPollRequest)

	return err
}

type NullablePostSendPollRequest struct {
	value *PostSendPollRequest
	isSet bool
}

func (v NullablePostSendPollRequest) Get() *PostSendPollRequest {
	return v.value
}

func (v *NullablePostSendPollRequest) Set(val *PostSendPollRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostSendPollRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostSendPollRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostSendPollRequest(val *PostSendPollRequest) *NullablePostSendPollRequest {
	return &NullablePostSendPollRequest{value: val, isSet: true}
}

func (v NullablePostSendPollRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostSendPollRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
