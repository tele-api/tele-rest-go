...
// checks if the PostCreateChatInviteLinkRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostCreateChatInviteLinkRequest{}

// PostCreateChatInviteLinkRequest struct for PostCreateChatInviteLinkRequest
type PostCreateChatInviteLinkRequest struct {
...
type _PostCreateChatInviteLinkRequest PostCreateChatInviteLinkRequest
...
func NewPostCreateChatInviteLinkRequest(chatId PostSendMessageRequestChatId) *PostCreateChatInviteLinkRequest {
	this := PostCreateChatInviteLinkRequest{}
	this.ChatId = chatId
	return &this
}
...
func (o PostCreateChatInviteLinkRequest) MarshalJSON() ([]byte, error) {
...
func (o PostCreateChatInviteLinkRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PostCreateChatInviteLinkRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPostCreateChatInviteLinkRequest := _PostCreateChatInviteLinkRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPostCreateChatInviteLinkRequest)

	if err != nil {
		return err
	}

	*o = PostCreateChatInviteLinkRequest(varPostCreateChatInviteLinkRequest)

	return err
}

type NullablePostCreateChatInviteLinkRequest struct {
	value *PostCreateChatInviteLinkRequest
	isSet bool
}

func (v NullablePostCreateChatInviteLinkRequest) Get() *PostCreateChatInviteLinkRequest {
	return v.value
}

func (v *NullablePostCreateChatInviteLinkRequest) Set(val *PostCreateChatInviteLinkRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostCreateChatInviteLinkRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostCreateChatInviteLinkRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostCreateChatInviteLinkRequest(val *PostCreateChatInviteLinkRequest) *NullablePostCreateChatInviteLinkRequest {
	return &NullablePostCreateChatInviteLinkRequest{value: val, isSet: true}
}

func (v NullablePostCreateChatInviteLinkRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostCreateChatInviteLinkRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
