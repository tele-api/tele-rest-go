...
// checks if the ForwardMessagesPostRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ForwardMessagesPostRequest{}

// ForwardMessagesPostRequest struct for ForwardMessagesPostRequest
type ForwardMessagesPostRequest struct {
...
type _ForwardMessagesPostRequest ForwardMessagesPostRequest
...
func NewForwardMessagesPostRequest(chatId SendMessagePostRequestChatId, fromChatId ForwardMessagesPostRequestFromChatId, messageIds []int32) *ForwardMessagesPostRequest {
	this := ForwardMessagesPostRequest{}
	this.ChatId = chatId
...
func (o ForwardMessagesPostRequest) MarshalJSON() ([]byte, error) {
...
func (o ForwardMessagesPostRequest) ToMap() (map[string]interface{}, error) {
...
func (o *ForwardMessagesPostRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varForwardMessagesPostRequest := _ForwardMessagesPostRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varForwardMessagesPostRequest)

	if err != nil {
		return err
	}

	*o = ForwardMessagesPostRequest(varForwardMessagesPostRequest)

	return err
}

type NullableForwardMessagesPostRequest struct {
	value *ForwardMessagesPostRequest
	isSet bool
}

func (v NullableForwardMessagesPostRequest) Get() *ForwardMessagesPostRequest {
	return v.value
}

func (v *NullableForwardMessagesPostRequest) Set(val *ForwardMessagesPostRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableForwardMessagesPostRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableForwardMessagesPostRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableForwardMessagesPostRequest(val *ForwardMessagesPostRequest) *NullableForwardMessagesPostRequest {
	return &NullableForwardMessagesPostRequest{value: val, isSet: true}
}

func (v NullableForwardMessagesPostRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableForwardMessagesPostRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
