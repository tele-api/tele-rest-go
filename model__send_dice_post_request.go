...
// checks if the SendDicePostRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SendDicePostRequest{}

// SendDicePostRequest struct for SendDicePostRequest
type SendDicePostRequest struct {
...
type _SendDicePostRequest SendDicePostRequest
...
func (o SendDicePostRequest) MarshalJSON() ([]byte, error) {
...
func (o SendDicePostRequest) ToMap() (map[string]interface{}, error) {
...
func (o *SendDicePostRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varSendDicePostRequest := _SendDicePostRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSendDicePostRequest)

	if err != nil {
		return err
	}

	*o = SendDicePostRequest(varSendDicePostRequest)

	return err
}

type NullableSendDicePostRequest struct {
	value *SendDicePostRequest
	isSet bool
}

func (v NullableSendDicePostRequest) Get() *SendDicePostRequest {
	return v.value
}

func (v *NullableSendDicePostRequest) Set(val *SendDicePostRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableSendDicePostRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableSendDicePostRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSendDicePostRequest(val *SendDicePostRequest) *NullableSendDicePostRequest {
	return &NullableSendDicePostRequest{value: val, isSet: true}
}

func (v NullableSendDicePostRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSendDicePostRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
