...
// checks if the SetMyShortDescriptionRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SetMyShortDescriptionRequest{}

// SetMyShortDescriptionRequest Request parameters for setMyShortDescription
...
func NewSetMyShortDescriptionRequest() *SetMyShortDescriptionRequest {
	this := SetMyShortDescriptionRequest{}
	return &this
}
...
func (o SetMyShortDescriptionRequest) MarshalJSON() ([]byte, error) {
...
func (o SetMyShortDescriptionRequest) ToMap() (map[string]interface{}, error) {
...
type NullableSetMyShortDescriptionRequest struct {
	value *SetMyShortDescriptionRequest
	isSet bool
}

func (v NullableSetMyShortDescriptionRequest) Get() *SetMyShortDescriptionRequest {
	return v.value
}

func (v *NullableSetMyShortDescriptionRequest) Set(val *SetMyShortDescriptionRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableSetMyShortDescriptionRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableSetMyShortDescriptionRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSetMyShortDescriptionRequest(val *SetMyShortDescriptionRequest) *NullableSetMyShortDescriptionRequest {
	return &NullableSetMyShortDescriptionRequest{value: val, isSet: true}
}

func (v NullableSetMyShortDescriptionRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSetMyShortDescriptionRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
