...
// checks if the SendInvoiceRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SendInvoiceRequest{}
...
type _SendInvoiceRequest SendInvoiceRequest
...
func (o SendInvoiceRequest) MarshalJSON() ([]byte, error) {
...
func (o SendInvoiceRequest) ToMap() (map[string]interface{}, error) {
...
func (o *SendInvoiceRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varSendInvoiceRequest := _SendInvoiceRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSendInvoiceRequest)

	if err != nil {
		return err
	}

	*o = SendInvoiceRequest(varSendInvoiceRequest)

	return err
}

type NullableSendInvoiceRequest struct {
	value *SendInvoiceRequest
	isSet bool
}

func (v NullableSendInvoiceRequest) Get() *SendInvoiceRequest {
	return v.value
}

func (v *NullableSendInvoiceRequest) Set(val *SendInvoiceRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableSendInvoiceRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableSendInvoiceRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSendInvoiceRequest(val *SendInvoiceRequest) *NullableSendInvoiceRequest {
	return &NullableSendInvoiceRequest{value: val, isSet: true}
}

func (v NullableSendInvoiceRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSendInvoiceRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
