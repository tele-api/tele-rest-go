...
// checks if the BackgroundTypeFill type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BackgroundTypeFill{}
...
type _BackgroundTypeFill BackgroundTypeFill
...
func (o BackgroundTypeFill) ToMap() (map[string]interface{}, error) {
...
func (o *BackgroundTypeFill) UnmarshalJSON(data []byte) (err error) {
	...
	varBackgroundTypeFill := _BackgroundTypeFill{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBackgroundTypeFill)

	if err != nil {
		return err
	}

	*o = BackgroundTypeFill(varBackgroundTypeFill)

	return err
}

type NullableBackgroundTypeFill struct {
	value *BackgroundTypeFill
	isSet bool
}

func (v NullableBackgroundTypeFill) Get() *BackgroundTypeFill {
	return v.value
}

func (v *NullableBackgroundTypeFill) Set(val *BackgroundTypeFill) {
	v.value = val
	v.isSet = true
}

func (v NullableBackgroundTypeFill) IsSet() bool {
	return v.isSet
}

func (v *NullableBackgroundTypeFill) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBackgroundTypeFill(val *BackgroundTypeFill) *NullableBackgroundTypeFill {
	return &NullableBackgroundTypeFill{value: val, isSet: true}
}

func (v NullableBackgroundTypeFill) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBackgroundTypeFill) UnmarshalJSON(src []byte) error {
	v.isSet = true
