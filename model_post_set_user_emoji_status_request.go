...
// checks if the PostSetUserEmojiStatusRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostSetUserEmojiStatusRequest{}

// PostSetUserEmojiStatusRequest struct for PostSetUserEmojiStatusRequest
type PostSetUserEmojiStatusRequest struct {
...
type _PostSetUserEmojiStatusRequest PostSetUserEmojiStatusRequest
...
func NewPostSetUserEmojiStatusRequest(userId int32) *PostSetUserEmojiStatusRequest {
	this := PostSetUserEmojiStatusRequest{}
	this.UserId = userId
	return &this
}
...
func (o PostSetUserEmojiStatusRequest) MarshalJSON() ([]byte, error) {
...
func (o PostSetUserEmojiStatusRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PostSetUserEmojiStatusRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPostSetUserEmojiStatusRequest := _PostSetUserEmojiStatusRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPostSetUserEmojiStatusRequest)

	if err != nil {
		return err
	}

	*o = PostSetUserEmojiStatusRequest(varPostSetUserEmojiStatusRequest)

	return err
}

type NullablePostSetUserEmojiStatusRequest struct {
	value *PostSetUserEmojiStatusRequest
	isSet bool
}

func (v NullablePostSetUserEmojiStatusRequest) Get() *PostSetUserEmojiStatusRequest {
	return v.value
}

func (v *NullablePostSetUserEmojiStatusRequest) Set(val *PostSetUserEmojiStatusRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostSetUserEmojiStatusRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostSetUserEmojiStatusRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostSetUserEmojiStatusRequest(val *PostSetUserEmojiStatusRequest) *NullablePostSetUserEmojiStatusRequest {
	return &NullablePostSetUserEmojiStatusRequest{value: val, isSet: true}
}

func (v NullablePostSetUserEmojiStatusRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostSetUserEmojiStatusRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
