...
// checks if the PostStopPollRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostStopPollRequest{}

// PostStopPollRequest struct for PostStopPollRequest
type PostStopPollRequest struct {
...
type _PostStopPollRequest PostStopPollRequest
...
func (o PostStopPollRequest) MarshalJSON() ([]byte, error) {
...
func (o PostStopPollRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PostStopPollRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPostStopPollRequest := _PostStopPollRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPostStopPollRequest)

	if err != nil {
		return err
	}

	*o = PostStopPollRequest(varPostStopPollRequest)

	return err
}

type NullablePostStopPollRequest struct {
	value *PostStopPollRequest
	isSet bool
}

func (v NullablePostStopPollRequest) Get() *PostStopPollRequest {
	return v.value
}

func (v *NullablePostStopPollRequest) Set(val *PostStopPollRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostStopPollRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostStopPollRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostStopPollRequest(val *PostStopPollRequest) *NullablePostStopPollRequest {
	return &NullablePostStopPollRequest{value: val, isSet: true}
}

func (v NullablePostStopPollRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostStopPollRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
