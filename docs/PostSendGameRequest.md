...
`func (o *PostSendGameRequest) SetMessageThreadId(v int32)`
...
`func (o *PostSendGameRequest) GetProtectContent() bool`
...
`func (o *PostSendGameRequest) GetMessageEffectIdOk() (*string, bool)`
