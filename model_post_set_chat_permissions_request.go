...
// checks if the PostSetChatPermissionsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostSetChatPermissionsRequest{}

// PostSetChatPermissionsRequest struct for PostSetChatPermissionsRequest
type PostSetChatPermissionsRequest struct {
...
type _PostSetChatPermissionsRequest PostSetChatPermissionsRequest
...
func NewPostSetChatPermissionsRequest(chatId PostRestrictChatMemberRequestChatId, permissions ChatPermissions) *PostSetChatPermissionsRequest {
	this := PostSetChatPermissionsRequest{}
	this.ChatId = chatId
...
func (o PostSetChatPermissionsRequest) MarshalJSON() ([]byte, error) {
...
func (o PostSetChatPermissionsRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PostSetChatPermissionsRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPostSetChatPermissionsRequest := _PostSetChatPermissionsRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPostSetChatPermissionsRequest)

	if err != nil {
		return err
	}

	*o = PostSetChatPermissionsRequest(varPostSetChatPermissionsRequest)

	return err
}

type NullablePostSetChatPermissionsRequest struct {
	value *PostSetChatPermissionsRequest
	isSet bool
}

func (v NullablePostSetChatPermissionsRequest) Get() *PostSetChatPermissionsRequest {
	return v.value
}

func (v *NullablePostSetChatPermissionsRequest) Set(val *PostSetChatPermissionsRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostSetChatPermissionsRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostSetChatPermissionsRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostSetChatPermissionsRequest(val *PostSetChatPermissionsRequest) *NullablePostSetChatPermissionsRequest {
	return &NullablePostSetChatPermissionsRequest{value: val, isSet: true}
}

func (v NullablePostSetChatPermissionsRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostSetChatPermissionsRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
