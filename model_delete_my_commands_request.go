...
// checks if the DeleteMyCommandsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteMyCommandsRequest{}

// DeleteMyCommandsRequest Request parameters for deleteMyCommands
...
func (o DeleteMyCommandsRequest) MarshalJSON() ([]byte, error) {
...
func (o DeleteMyCommandsRequest) ToMap() (map[string]interface{}, error) {
...
type NullableDeleteMyCommandsRequest struct {
	value *DeleteMyCommandsRequest
	isSet bool
}

func (v NullableDeleteMyCommandsRequest) Get() *DeleteMyCommandsRequest {
	return v.value
}

func (v *NullableDeleteMyCommandsRequest) Set(val *DeleteMyCommandsRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteMyCommandsRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteMyCommandsRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteMyCommandsRequest(val *DeleteMyCommandsRequest) *NullableDeleteMyCommandsRequest {
	return &NullableDeleteMyCommandsRequest{value: val, isSet: true}
}

func (v NullableDeleteMyCommandsRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteMyCommandsRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
