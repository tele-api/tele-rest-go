...
// checks if the PostSendInvoiceRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostSendInvoiceRequest{}

// PostSendInvoiceRequest struct for PostSendInvoiceRequest
type PostSendInvoiceRequest struct {
...
type _PostSendInvoiceRequest PostSendInvoiceRequest
...
func (o PostSendInvoiceRequest) MarshalJSON() ([]byte, error) {
...
func (o PostSendInvoiceRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PostSendInvoiceRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPostSendInvoiceRequest := _PostSendInvoiceRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPostSendInvoiceRequest)

	if err != nil {
		return err
	}

	*o = PostSendInvoiceRequest(varPostSendInvoiceRequest)

	return err
}

type NullablePostSendInvoiceRequest struct {
	value *PostSendInvoiceRequest
	isSet bool
}

func (v NullablePostSendInvoiceRequest) Get() *PostSendInvoiceRequest {
	return v.value
}

func (v *NullablePostSendInvoiceRequest) Set(val *PostSendInvoiceRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostSendInvoiceRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostSendInvoiceRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostSendInvoiceRequest(val *PostSendInvoiceRequest) *NullablePostSendInvoiceRequest {
	return &NullablePostSendInvoiceRequest{value: val, isSet: true}
}

func (v NullablePostSendInvoiceRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostSendInvoiceRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
