...
// checks if the PostSendDiceRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostSendDiceRequest{}

// PostSendDiceRequest struct for PostSendDiceRequest
type PostSendDiceRequest struct {
...
type _PostSendDiceRequest PostSendDiceRequest
...
func (o PostSendDiceRequest) MarshalJSON() ([]byte, error) {
...
func (o PostSendDiceRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PostSendDiceRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPostSendDiceRequest := _PostSendDiceRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPostSendDiceRequest)

	if err != nil {
		return err
	}

	*o = PostSendDiceRequest(varPostSendDiceRequest)

	return err
}

type NullablePostSendDiceRequest struct {
	value *PostSendDiceRequest
	isSet bool
}

func (v NullablePostSendDiceRequest) Get() *PostSendDiceRequest {
	return v.value
}

func (v *NullablePostSendDiceRequest) Set(val *PostSendDiceRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostSendDiceRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostSendDiceRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostSendDiceRequest(val *PostSendDiceRequest) *NullablePostSendDiceRequest {
	return &NullablePostSendDiceRequest{value: val, isSet: true}
}

func (v NullablePostSendDiceRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostSendDiceRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
