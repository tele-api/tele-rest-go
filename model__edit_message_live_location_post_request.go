...
// checks if the EditMessageLiveLocationPostRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EditMessageLiveLocationPostRequest{}

// EditMessageLiveLocationPostRequest struct for EditMessageLiveLocationPostRequest
type EditMessageLiveLocationPostRequest struct {
...
type _EditMessageLiveLocationPostRequest EditMessageLiveLocationPostRequest
...
func NewEditMessageLiveLocationPostRequest(latitude float32, longitude float32) *EditMessageLiveLocationPostRequest {
	this := EditMessageLiveLocationPostRequest{}
...
func (o EditMessageLiveLocationPostRequest) MarshalJSON() ([]byte, error) {
...
func (o EditMessageLiveLocationPostRequest) ToMap() (map[string]interface{}, error) {
...
func (o *EditMessageLiveLocationPostRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varEditMessageLiveLocationPostRequest := _EditMessageLiveLocationPostRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEditMessageLiveLocationPostRequest)

	if err != nil {
		return err
	}

	*o = EditMessageLiveLocationPostRequest(varEditMessageLiveLocationPostRequest)

	return err
}

type NullableEditMessageLiveLocationPostRequest struct {
	value *EditMessageLiveLocationPostRequest
	isSet bool
}

func (v NullableEditMessageLiveLocationPostRequest) Get() *EditMessageLiveLocationPostRequest {
	return v.value
}

func (v *NullableEditMessageLiveLocationPostRequest) Set(val *EditMessageLiveLocationPostRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableEditMessageLiveLocationPostRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableEditMessageLiveLocationPostRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEditMessageLiveLocationPostRequest(val *EditMessageLiveLocationPostRequest) *NullableEditMessageLiveLocationPostRequest {
	return &NullableEditMessageLiveLocationPostRequest{value: val, isSet: true}
}

func (v NullableEditMessageLiveLocationPostRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEditMessageLiveLocationPostRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
