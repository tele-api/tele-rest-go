...
// checks if the SetUserEmojiStatusPostRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SetUserEmojiStatusPostRequest{}

// SetUserEmojiStatusPostRequest struct for SetUserEmojiStatusPostRequest
type SetUserEmojiStatusPostRequest struct {
...
type _SetUserEmojiStatusPostRequest SetUserEmojiStatusPostRequest
...
func NewSetUserEmojiStatusPostRequest(userId int32) *SetUserEmojiStatusPostRequest {
	this := SetUserEmojiStatusPostRequest{}
	this.UserId = userId
	return &this
}
...
func (o SetUserEmojiStatusPostRequest) MarshalJSON() ([]byte, error) {
...
func (o SetUserEmojiStatusPostRequest) ToMap() (map[string]interface{}, error) {
...
func (o *SetUserEmojiStatusPostRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varSetUserEmojiStatusPostRequest := _SetUserEmojiStatusPostRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSetUserEmojiStatusPostRequest)

	if err != nil {
		return err
	}

	*o = SetUserEmojiStatusPostRequest(varSetUserEmojiStatusPostRequest)

	return err
}

type NullableSetUserEmojiStatusPostRequest struct {
	value *SetUserEmojiStatusPostRequest
	isSet bool
}

func (v NullableSetUserEmojiStatusPostRequest) Get() *SetUserEmojiStatusPostRequest {
	return v.value
}

func (v *NullableSetUserEmojiStatusPostRequest) Set(val *SetUserEmojiStatusPostRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableSetUserEmojiStatusPostRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableSetUserEmojiStatusPostRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSetUserEmojiStatusPostRequest(val *SetUserEmojiStatusPostRequest) *NullableSetUserEmojiStatusPostRequest {
	return &NullableSetUserEmojiStatusPostRequest{value: val, isSet: true}
}

func (v NullableSetUserEmojiStatusPostRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSetUserEmojiStatusPostRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
