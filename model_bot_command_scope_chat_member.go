...
// checks if the BotCommandScopeChatMember type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BotCommandScopeChatMember{}
...
type _BotCommandScopeChatMember BotCommandScopeChatMember
...
func (o BotCommandScopeChatMember) ToMap() (map[string]interface{}, error) {
...
func (o *BotCommandScopeChatMember) UnmarshalJSON(data []byte) (err error) {
	...
	varBotCommandScopeChatMember := _BotCommandScopeChatMember{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBotCommandScopeChatMember)

	if err != nil {
		return err
	}

	*o = BotCommandScopeChatMember(varBotCommandScopeChatMember)

	return err
}

type NullableBotCommandScopeChatMember struct {
	value *BotCommandScopeChatMember
	isSet bool
}

func (v NullableBotCommandScopeChatMember) Get() *BotCommandScopeChatMember {
	return v.value
}

func (v *NullableBotCommandScopeChatMember) Set(val *BotCommandScopeChatMember) {
	v.value = val
	v.isSet = true
}

func (v NullableBotCommandScopeChatMember) IsSet() bool {
	return v.isSet
}

func (v *NullableBotCommandScopeChatMember) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBotCommandScopeChatMember(val *BotCommandScopeChatMember) *NullableBotCommandScopeChatMember {
	return &NullableBotCommandScopeChatMember{value: val, isSet: true}
}

func (v NullableBotCommandScopeChatMember) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBotCommandScopeChatMember) UnmarshalJSON(src []byte) error {
	v.isSet = true
