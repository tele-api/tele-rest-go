...
// checks if the VerifyUserRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VerifyUserRequest{}

// VerifyUserRequest Request parameters for verifyUser
...
type _VerifyUserRequest VerifyUserRequest
...
func (o VerifyUserRequest) MarshalJSON() ([]byte, error) {
...
func (o VerifyUserRequest) ToMap() (map[string]interface{}, error) {
...
func (o *VerifyUserRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varVerifyUserRequest := _VerifyUserRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVerifyUserRequest)

	if err != nil {
		return err
	}

	*o = VerifyUserRequest(varVerifyUserRequest)

	return err
}

type NullableVerifyUserRequest struct {
	value *VerifyUserRequest
	isSet bool
}

func (v NullableVerifyUserRequest) Get() *VerifyUserRequest {
	return v.value
}

func (v *NullableVerifyUserRequest) Set(val *VerifyUserRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableVerifyUserRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableVerifyUserRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVerifyUserRequest(val *VerifyUserRequest) *NullableVerifyUserRequest {
	return &NullableVerifyUserRequest{value: val, isSet: true}
}

func (v NullableVerifyUserRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVerifyUserRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
