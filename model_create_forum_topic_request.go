...
// checks if the CreateForumTopicRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateForumTopicRequest{}
...
type _CreateForumTopicRequest CreateForumTopicRequest
...
func (o CreateForumTopicRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateForumTopicRequest) ToMap() (map[string]interface{}, error) {
...
func (o *CreateForumTopicRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateForumTopicRequest := _CreateForumTopicRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateForumTopicRequest)

	if err != nil {
		return err
	}

	*o = CreateForumTopicRequest(varCreateForumTopicRequest)

	return err
}

type NullableCreateForumTopicRequest struct {
	value *CreateForumTopicRequest
	isSet bool
}

func (v NullableCreateForumTopicRequest) Get() *CreateForumTopicRequest {
	return v.value
}

func (v *NullableCreateForumTopicRequest) Set(val *CreateForumTopicRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateForumTopicRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateForumTopicRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateForumTopicRequest(val *CreateForumTopicRequest) *NullableCreateForumTopicRequest {
	return &NullableCreateForumTopicRequest{value: val, isSet: true}
}

func (v NullableCreateForumTopicRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateForumTopicRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
