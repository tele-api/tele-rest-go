...
// checks if the SendChatActionPostRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SendChatActionPostRequest{}

// SendChatActionPostRequest struct for SendChatActionPostRequest
type SendChatActionPostRequest struct {
...
type _SendChatActionPostRequest SendChatActionPostRequest
...
func NewSendChatActionPostRequest(chatId SendMessagePostRequestChatId, action string) *SendChatActionPostRequest {
	this := SendChatActionPostRequest{}
	this.ChatId = chatId
	this.Action = action
	return &this
}
...
func (o SendChatActionPostRequest) MarshalJSON() ([]byte, error) {
...
func (o SendChatActionPostRequest) ToMap() (map[string]interface{}, error) {
...
func (o *SendChatActionPostRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varSendChatActionPostRequest := _SendChatActionPostRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSendChatActionPostRequest)

	if err != nil {
		return err
	}

	*o = SendChatActionPostRequest(varSendChatActionPostRequest)

	return err
}

type NullableSendChatActionPostRequest struct {
	value *SendChatActionPostRequest
	isSet bool
}

func (v NullableSendChatActionPostRequest) Get() *SendChatActionPostRequest {
	return v.value
}

func (v *NullableSendChatActionPostRequest) Set(val *SendChatActionPostRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableSendChatActionPostRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableSendChatActionPostRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSendChatActionPostRequest(val *SendChatActionPostRequest) *NullableSendChatActionPostRequest {
	return &NullableSendChatActionPostRequest{value: val, isSet: true}
}

func (v NullableSendChatActionPostRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSendChatActionPostRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
