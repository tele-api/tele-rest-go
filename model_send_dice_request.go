...
// checks if the SendDiceRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SendDiceRequest{}

// SendDiceRequest Request parameters for sendDice
...
type _SendDiceRequest SendDiceRequest
...
func (o SendDiceRequest) MarshalJSON() ([]byte, error) {
...
func (o SendDiceRequest) ToMap() (map[string]interface{}, error) {
...
func (o *SendDiceRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varSendDiceRequest := _SendDiceRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSendDiceRequest)

	if err != nil {
		return err
	}

	*o = SendDiceRequest(varSendDiceRequest)

	return err
}

type NullableSendDiceRequest struct {
	value *SendDiceRequest
	isSet bool
}

func (v NullableSendDiceRequest) Get() *SendDiceRequest {
	return v.value
}

func (v *NullableSendDiceRequest) Set(val *SendDiceRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableSendDiceRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableSendDiceRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSendDiceRequest(val *SendDiceRequest) *NullableSendDiceRequest {
	return &NullableSendDiceRequest{value: val, isSet: true}
}

func (v NullableSendDiceRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSendDiceRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
