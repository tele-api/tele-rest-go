...
// checks if the EditMessageCaptionPostRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EditMessageCaptionPostRequest{}

// EditMessageCaptionPostRequest struct for EditMessageCaptionPostRequest
type EditMessageCaptionPostRequest struct {
...
func NewEditMessageCaptionPostRequest() *EditMessageCaptionPostRequest {
	this := EditMessageCaptionPostRequest{}
	return &this
}
...
func (o EditMessageCaptionPostRequest) MarshalJSON() ([]byte, error) {
...
func (o EditMessageCaptionPostRequest) ToMap() (map[string]interface{}, error) {
...
type NullableEditMessageCaptionPostRequest struct {
	value *EditMessageCaptionPostRequest
	isSet bool
}

func (v NullableEditMessageCaptionPostRequest) Get() *EditMessageCaptionPostRequest {
	return v.value
}

func (v *NullableEditMessageCaptionPostRequest) Set(val *EditMessageCaptionPostRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableEditMessageCaptionPostRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableEditMessageCaptionPostRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEditMessageCaptionPostRequest(val *EditMessageCaptionPostRequest) *NullableEditMessageCaptionPostRequest {
	return &NullableEditMessageCaptionPostRequest{value: val, isSet: true}
}

func (v NullableEditMessageCaptionPostRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEditMessageCaptionPostRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
