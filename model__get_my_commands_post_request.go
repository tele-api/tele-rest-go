...
// checks if the GetMyCommandsPostRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetMyCommandsPostRequest{}

// GetMyCommandsPostRequest struct for GetMyCommandsPostRequest
type GetMyCommandsPostRequest struct {
...
func (o GetMyCommandsPostRequest) MarshalJSON() ([]byte, error) {
...
func (o GetMyCommandsPostRequest) ToMap() (map[string]interface{}, error) {
...
type NullableGetMyCommandsPostRequest struct {
	value *GetMyCommandsPostRequest
	isSet bool
}

func (v NullableGetMyCommandsPostRequest) Get() *GetMyCommandsPostRequest {
	return v.value
}

func (v *NullableGetMyCommandsPostRequest) Set(val *GetMyCommandsPostRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableGetMyCommandsPostRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableGetMyCommandsPostRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetMyCommandsPostRequest(val *GetMyCommandsPostRequest) *NullableGetMyCommandsPostRequest {
	return &NullableGetMyCommandsPostRequest{value: val, isSet: true}
}

func (v NullableGetMyCommandsPostRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetMyCommandsPostRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
