...
// checks if the PostAnswerInlineQueryRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostAnswerInlineQueryRequest{}

// PostAnswerInlineQueryRequest struct for PostAnswerInlineQueryRequest
type PostAnswerInlineQueryRequest struct {
...
type _PostAnswerInlineQueryRequest PostAnswerInlineQueryRequest
...
func NewPostAnswerInlineQueryRequest(inlineQueryId string, results []InlineQueryResult) *PostAnswerInlineQueryRequest {
	this := PostAnswerInlineQueryRequest{}
...
func (o PostAnswerInlineQueryRequest) MarshalJSON() ([]byte, error) {
...
func (o PostAnswerInlineQueryRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PostAnswerInlineQueryRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPostAnswerInlineQueryRequest := _PostAnswerInlineQueryRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPostAnswerInlineQueryRequest)

	if err != nil {
		return err
	}

	*o = PostAnswerInlineQueryRequest(varPostAnswerInlineQueryRequest)

	return err
}

type NullablePostAnswerInlineQueryRequest struct {
	value *PostAnswerInlineQueryRequest
	isSet bool
}

func (v NullablePostAnswerInlineQueryRequest) Get() *PostAnswerInlineQueryRequest {
	return v.value
}

func (v *NullablePostAnswerInlineQueryRequest) Set(val *PostAnswerInlineQueryRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostAnswerInlineQueryRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostAnswerInlineQueryRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostAnswerInlineQueryRequest(val *PostAnswerInlineQueryRequest) *NullablePostAnswerInlineQueryRequest {
	return &NullablePostAnswerInlineQueryRequest{value: val, isSet: true}
}

func (v NullablePostAnswerInlineQueryRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostAnswerInlineQueryRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
