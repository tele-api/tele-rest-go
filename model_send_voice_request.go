...
// checks if the SendVoiceRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SendVoiceRequest{}

// SendVoiceRequest Request parameters for sendVoice
...
type _SendVoiceRequest SendVoiceRequest
...
func (o SendVoiceRequest) MarshalJSON() ([]byte, error) {
...
func (o SendVoiceRequest) ToMap() (map[string]interface{}, error) {
...
func (o *SendVoiceRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varSendVoiceRequest := _SendVoiceRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSendVoiceRequest)

	if err != nil {
		return err
	}

	*o = SendVoiceRequest(varSendVoiceRequest)

	return err
}

type NullableSendVoiceRequest struct {
	value *SendVoiceRequest
	isSet bool
}

func (v NullableSendVoiceRequest) Get() *SendVoiceRequest {
	return v.value
}

func (v *NullableSendVoiceRequest) Set(val *SendVoiceRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableSendVoiceRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableSendVoiceRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSendVoiceRequest(val *SendVoiceRequest) *NullableSendVoiceRequest {
	return &NullableSendVoiceRequest{value: val, isSet: true}
}

func (v NullableSendVoiceRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSendVoiceRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
