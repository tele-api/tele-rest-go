...
// interface{}AsSendAudioPostRequestAudio is a convenience function that returns interface{} wrapped in SendAudioPostRequestAudio
func AnyAsSendAudioPostRequestAudio(v *interface{}) SendAudioPostRequestAudio {
	return SendAudioPostRequestAudio{
		Any: v,
	}
}

// stringAsSendAudioPostRequestAudio is a convenience function that returns string wrapped in SendAudioPostRequestAudio
func StringAsSendAudioPostRequestAudio(v *string) SendAudioPostRequestAudio {
	return SendAudioPostRequestAudio{
		String: v,
	}
}
...
func (dst *SendAudioPostRequestAudio) UnmarshalJSON(data []byte) error {
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(SendAudioPostRequestAudio)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(SendAudioPostRequestAudio)")
	}
}
...
func (obj *SendAudioPostRequestAudio) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
	if obj.Any != nil {
...
func (obj SendAudioPostRequestAudio) GetActualInstanceValue() (interface{}) {
	if obj.Any != nil {
		return *obj.Any
	}
