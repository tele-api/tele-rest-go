...
// checks if the SavePreparedInlineMessageRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SavePreparedInlineMessageRequest{}

// SavePreparedInlineMessageRequest Request parameters for savePreparedInlineMessage
...
type _SavePreparedInlineMessageRequest SavePreparedInlineMessageRequest
...
func NewSavePreparedInlineMessageRequest(userId int32, result InlineQueryResult) *SavePreparedInlineMessageRequest {
	this := SavePreparedInlineMessageRequest{}
	this.UserId = userId
	this.Result = result
	return &this
}
...
func (o SavePreparedInlineMessageRequest) MarshalJSON() ([]byte, error) {
...
func (o SavePreparedInlineMessageRequest) ToMap() (map[string]interface{}, error) {
...
func (o *SavePreparedInlineMessageRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varSavePreparedInlineMessageRequest := _SavePreparedInlineMessageRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSavePreparedInlineMessageRequest)

	if err != nil {
		return err
	}

	*o = SavePreparedInlineMessageRequest(varSavePreparedInlineMessageRequest)

	return err
}

type NullableSavePreparedInlineMessageRequest struct {
	value *SavePreparedInlineMessageRequest
	isSet bool
}

func (v NullableSavePreparedInlineMessageRequest) Get() *SavePreparedInlineMessageRequest {
	return v.value
}

func (v *NullableSavePreparedInlineMessageRequest) Set(val *SavePreparedInlineMessageRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableSavePreparedInlineMessageRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableSavePreparedInlineMessageRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSavePreparedInlineMessageRequest(val *SavePreparedInlineMessageRequest) *NullableSavePreparedInlineMessageRequest {
	return &NullableSavePreparedInlineMessageRequest{value: val, isSet: true}
}

func (v NullableSavePreparedInlineMessageRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSavePreparedInlineMessageRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
