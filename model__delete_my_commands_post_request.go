...
// checks if the DeleteMyCommandsPostRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteMyCommandsPostRequest{}

// DeleteMyCommandsPostRequest struct for DeleteMyCommandsPostRequest
type DeleteMyCommandsPostRequest struct {
...
func NewDeleteMyCommandsPostRequest() *DeleteMyCommandsPostRequest {
	this := DeleteMyCommandsPostRequest{}
	return &this
}
...
func (o DeleteMyCommandsPostRequest) MarshalJSON() ([]byte, error) {
...
func (o DeleteMyCommandsPostRequest) ToMap() (map[string]interface{}, error) {
...
type NullableDeleteMyCommandsPostRequest struct {
	value *DeleteMyCommandsPostRequest
	isSet bool
}

func (v NullableDeleteMyCommandsPostRequest) Get() *DeleteMyCommandsPostRequest {
	return v.value
}

func (v *NullableDeleteMyCommandsPostRequest) Set(val *DeleteMyCommandsPostRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteMyCommandsPostRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteMyCommandsPostRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteMyCommandsPostRequest(val *DeleteMyCommandsPostRequest) *NullableDeleteMyCommandsPostRequest {
	return &NullableDeleteMyCommandsPostRequest{value: val, isSet: true}
}

func (v NullableDeleteMyCommandsPostRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteMyCommandsPostRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
