...
// checks if the EditChatInviteLinkPostRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EditChatInviteLinkPostRequest{}

// EditChatInviteLinkPostRequest struct for EditChatInviteLinkPostRequest
type EditChatInviteLinkPostRequest struct {
...
type _EditChatInviteLinkPostRequest EditChatInviteLinkPostRequest
...
func NewEditChatInviteLinkPostRequest(chatId SendMessagePostRequestChatId, inviteLink string) *EditChatInviteLinkPostRequest {
	this := EditChatInviteLinkPostRequest{}
	this.ChatId = chatId
...
func (o EditChatInviteLinkPostRequest) MarshalJSON() ([]byte, error) {
...
func (o EditChatInviteLinkPostRequest) ToMap() (map[string]interface{}, error) {
...
func (o *EditChatInviteLinkPostRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varEditChatInviteLinkPostRequest := _EditChatInviteLinkPostRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEditChatInviteLinkPostRequest)

	if err != nil {
		return err
	}

	*o = EditChatInviteLinkPostRequest(varEditChatInviteLinkPostRequest)

	return err
}

type NullableEditChatInviteLinkPostRequest struct {
	value *EditChatInviteLinkPostRequest
	isSet bool
}

func (v NullableEditChatInviteLinkPostRequest) Get() *EditChatInviteLinkPostRequest {
	return v.value
}

func (v *NullableEditChatInviteLinkPostRequest) Set(val *EditChatInviteLinkPostRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableEditChatInviteLinkPostRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableEditChatInviteLinkPostRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEditChatInviteLinkPostRequest(val *EditChatInviteLinkPostRequest) *NullableEditChatInviteLinkPostRequest {
	return &NullableEditChatInviteLinkPostRequest{value: val, isSet: true}
}

func (v NullableEditChatInviteLinkPostRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEditChatInviteLinkPostRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
