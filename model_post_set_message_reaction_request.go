...
// checks if the PostSetMessageReactionRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostSetMessageReactionRequest{}

// PostSetMessageReactionRequest struct for PostSetMessageReactionRequest
type PostSetMessageReactionRequest struct {
...
type _PostSetMessageReactionRequest PostSetMessageReactionRequest
...
func NewPostSetMessageReactionRequest(chatId PostSendMessageRequestChatId, messageId int32) *PostSetMessageReactionRequest {
	this := PostSetMessageReactionRequest{}
	this.ChatId = chatId
...
func (o PostSetMessageReactionRequest) MarshalJSON() ([]byte, error) {
...
func (o PostSetMessageReactionRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PostSetMessageReactionRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPostSetMessageReactionRequest := _PostSetMessageReactionRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPostSetMessageReactionRequest)

	if err != nil {
		return err
	}

	*o = PostSetMessageReactionRequest(varPostSetMessageReactionRequest)

	return err
}

type NullablePostSetMessageReactionRequest struct {
	value *PostSetMessageReactionRequest
	isSet bool
}

func (v NullablePostSetMessageReactionRequest) Get() *PostSetMessageReactionRequest {
	return v.value
}

func (v *NullablePostSetMessageReactionRequest) Set(val *PostSetMessageReactionRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostSetMessageReactionRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostSetMessageReactionRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostSetMessageReactionRequest(val *PostSetMessageReactionRequest) *NullablePostSetMessageReactionRequest {
	return &NullablePostSetMessageReactionRequest{value: val, isSet: true}
}

func (v NullablePostSetMessageReactionRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostSetMessageReactionRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
