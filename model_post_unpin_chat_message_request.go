...
// checks if the PostUnpinChatMessageRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostUnpinChatMessageRequest{}

// PostUnpinChatMessageRequest struct for PostUnpinChatMessageRequest
type PostUnpinChatMessageRequest struct {
...
type _PostUnpinChatMessageRequest PostUnpinChatMessageRequest
...
func NewPostUnpinChatMessageRequest(chatId PostSendMessageRequestChatId) *PostUnpinChatMessageRequest {
	this := PostUnpinChatMessageRequest{}
	this.ChatId = chatId
	return &this
}
...
func (o PostUnpinChatMessageRequest) MarshalJSON() ([]byte, error) {
...
func (o PostUnpinChatMessageRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PostUnpinChatMessageRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPostUnpinChatMessageRequest := _PostUnpinChatMessageRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPostUnpinChatMessageRequest)

	if err != nil {
		return err
	}

	*o = PostUnpinChatMessageRequest(varPostUnpinChatMessageRequest)

	return err
}

type NullablePostUnpinChatMessageRequest struct {
	value *PostUnpinChatMessageRequest
	isSet bool
}

func (v NullablePostUnpinChatMessageRequest) Get() *PostUnpinChatMessageRequest {
	return v.value
}

func (v *NullablePostUnpinChatMessageRequest) Set(val *PostUnpinChatMessageRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostUnpinChatMessageRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostUnpinChatMessageRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostUnpinChatMessageRequest(val *PostUnpinChatMessageRequest) *NullablePostUnpinChatMessageRequest {
	return &NullablePostUnpinChatMessageRequest{value: val, isSet: true}
}

func (v NullablePostUnpinChatMessageRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostUnpinChatMessageRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
