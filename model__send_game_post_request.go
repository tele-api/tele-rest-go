...
// checks if the SendGamePostRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SendGamePostRequest{}

// SendGamePostRequest struct for SendGamePostRequest
type SendGamePostRequest struct {
...
type _SendGamePostRequest SendGamePostRequest
...
func (o *SendGamePostRequest) SetMessageThreadId(v int32) {
	o.MessageThreadId = &v
}
...
func (o *SendGamePostRequest) GetProtectContent() bool {
...
// and a boolean to check if the value has been set.
func (o *SendGamePostRequest) GetMessageEffectIdOk() (*string, bool) {
	if o == nil || IsNil(o.MessageEffectId) {
		return nil, false
	}
...
func (o SendGamePostRequest) MarshalJSON() ([]byte, error) {
...
func (o SendGamePostRequest) ToMap() (map[string]interface{}, error) {
...
func (o *SendGamePostRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varSendGamePostRequest := _SendGamePostRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSendGamePostRequest)

	if err != nil {
		return err
	}

	*o = SendGamePostRequest(varSendGamePostRequest)

	return err
}

type NullableSendGamePostRequest struct {
	value *SendGamePostRequest
	isSet bool
}

func (v NullableSendGamePostRequest) Get() *SendGamePostRequest {
	return v.value
}

func (v *NullableSendGamePostRequest) Set(val *SendGamePostRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableSendGamePostRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableSendGamePostRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSendGamePostRequest(val *SendGamePostRequest) *NullableSendGamePostRequest {
	return &NullableSendGamePostRequest{value: val, isSet: true}
}

func (v NullableSendGamePostRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSendGamePostRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
