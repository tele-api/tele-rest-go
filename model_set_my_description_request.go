...
// checks if the SetMyDescriptionRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SetMyDescriptionRequest{}

// SetMyDescriptionRequest Request parameters for setMyDescription
...
func (o SetMyDescriptionRequest) MarshalJSON() ([]byte, error) {
...
func (o SetMyDescriptionRequest) ToMap() (map[string]interface{}, error) {
...
type NullableSetMyDescriptionRequest struct {
	value *SetMyDescriptionRequest
	isSet bool
}

func (v NullableSetMyDescriptionRequest) Get() *SetMyDescriptionRequest {
	return v.value
}

func (v *NullableSetMyDescriptionRequest) Set(val *SetMyDescriptionRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableSetMyDescriptionRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableSetMyDescriptionRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSetMyDescriptionRequest(val *SetMyDescriptionRequest) *NullableSetMyDescriptionRequest {
	return &NullableSetMyDescriptionRequest{value: val, isSet: true}
}

func (v NullableSetMyDescriptionRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSetMyDescriptionRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
