...
// checks if the PostSendChatActionRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostSendChatActionRequest{}

// PostSendChatActionRequest struct for PostSendChatActionRequest
type PostSendChatActionRequest struct {
...
type _PostSendChatActionRequest PostSendChatActionRequest
...
func NewPostSendChatActionRequest(chatId PostSendMessageRequestChatId, action string) *PostSendChatActionRequest {
	this := PostSendChatActionRequest{}
	this.ChatId = chatId
	this.Action = action
	return &this
}
...
func (o PostSendChatActionRequest) MarshalJSON() ([]byte, error) {
...
func (o PostSendChatActionRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PostSendChatActionRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPostSendChatActionRequest := _PostSendChatActionRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPostSendChatActionRequest)

	if err != nil {
		return err
	}

	*o = PostSendChatActionRequest(varPostSendChatActionRequest)

	return err
}

type NullablePostSendChatActionRequest struct {
	value *PostSendChatActionRequest
	isSet bool
}

func (v NullablePostSendChatActionRequest) Get() *PostSendChatActionRequest {
	return v.value
}

func (v *NullablePostSendChatActionRequest) Set(val *PostSendChatActionRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostSendChatActionRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostSendChatActionRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostSendChatActionRequest(val *PostSendChatActionRequest) *NullablePostSendChatActionRequest {
	return &NullablePostSendChatActionRequest{value: val, isSet: true}
}

func (v NullablePostSendChatActionRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostSendChatActionRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
