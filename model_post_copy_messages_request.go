...
// checks if the PostCopyMessagesRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostCopyMessagesRequest{}

// PostCopyMessagesRequest struct for PostCopyMessagesRequest
type PostCopyMessagesRequest struct {
...
type _PostCopyMessagesRequest PostCopyMessagesRequest
...
func (o PostCopyMessagesRequest) MarshalJSON() ([]byte, error) {
...
func (o PostCopyMessagesRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PostCopyMessagesRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPostCopyMessagesRequest := _PostCopyMessagesRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPostCopyMessagesRequest)

	if err != nil {
		return err
	}

	*o = PostCopyMessagesRequest(varPostCopyMessagesRequest)

	return err
}

type NullablePostCopyMessagesRequest struct {
	value *PostCopyMessagesRequest
	isSet bool
}

func (v NullablePostCopyMessagesRequest) Get() *PostCopyMessagesRequest {
	return v.value
}

func (v *NullablePostCopyMessagesRequest) Set(val *PostCopyMessagesRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostCopyMessagesRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostCopyMessagesRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostCopyMessagesRequest(val *PostCopyMessagesRequest) *NullablePostCopyMessagesRequest {
	return &NullablePostCopyMessagesRequest{value: val, isSet: true}
}

func (v NullablePostCopyMessagesRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostCopyMessagesRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
