...
// checks if the VerifyChatRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VerifyChatRequest{}

// VerifyChatRequest Request parameters for verifyChat
...
type _VerifyChatRequest VerifyChatRequest
...
func (o VerifyChatRequest) MarshalJSON() ([]byte, error) {
...
func (o VerifyChatRequest) ToMap() (map[string]interface{}, error) {
...
func (o *VerifyChatRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varVerifyChatRequest := _VerifyChatRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVerifyChatRequest)

	if err != nil {
		return err
	}

	*o = VerifyChatRequest(varVerifyChatRequest)

	return err
}

type NullableVerifyChatRequest struct {
	value *VerifyChatRequest
	isSet bool
}

func (v NullableVerifyChatRequest) Get() *VerifyChatRequest {
	return v.value
}

func (v *NullableVerifyChatRequest) Set(val *VerifyChatRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableVerifyChatRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableVerifyChatRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVerifyChatRequest(val *VerifyChatRequest) *NullableVerifyChatRequest {
	return &NullableVerifyChatRequest{value: val, isSet: true}
}

func (v NullableVerifyChatRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVerifyChatRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
