...
// checks if the PostEditMessageCaptionRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostEditMessageCaptionRequest{}

// PostEditMessageCaptionRequest struct for PostEditMessageCaptionRequest
type PostEditMessageCaptionRequest struct {
...
func NewPostEditMessageCaptionRequest() *PostEditMessageCaptionRequest {
	this := PostEditMessageCaptionRequest{}
	return &this
}
...
func (o PostEditMessageCaptionRequest) MarshalJSON() ([]byte, error) {
...
func (o PostEditMessageCaptionRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePostEditMessageCaptionRequest struct {
	value *PostEditMessageCaptionRequest
	isSet bool
}

func (v NullablePostEditMessageCaptionRequest) Get() *PostEditMessageCaptionRequest {
	return v.value
}

func (v *NullablePostEditMessageCaptionRequest) Set(val *PostEditMessageCaptionRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostEditMessageCaptionRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostEditMessageCaptionRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostEditMessageCaptionRequest(val *PostEditMessageCaptionRequest) *NullablePostEditMessageCaptionRequest {
	return &NullablePostEditMessageCaptionRequest{value: val, isSet: true}
}

func (v NullablePostEditMessageCaptionRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostEditMessageCaptionRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
