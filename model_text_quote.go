...
// checks if the TextQuote type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TextQuote{}
...
func (o TextQuote) MarshalJSON() ([]byte, error) {
...
func (o TextQuote) ToMap() (map[string]interface{}, error) {
...
func (o *TextQuote) UnmarshalJSON(data []byte) (err error) {
	...
	varTextQuote := _TextQuote{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTextQuote)

	if err != nil {
		return err
	}

	*o = TextQuote(varTextQuote)

	return err
}

type NullableTextQuote struct {
	value *TextQuote
	isSet bool
}

func (v NullableTextQuote) Get() *TextQuote {
	return v.value
}

func (v *NullableTextQuote) Set(val *TextQuote) {
	v.value = val
	v.isSet = true
}

func (v NullableTextQuote) IsSet() bool {
	return v.isSet
}

func (v *NullableTextQuote) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTextQuote(val *TextQuote) *NullableTextQuote {
	return &NullableTextQuote{value: val, isSet: true}
}

func (v NullableTextQuote) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTextQuote) UnmarshalJSON(src []byte) error {
	v.isSet = true
