...
// checks if the UpgradeGiftPostRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpgradeGiftPostRequest{}

// UpgradeGiftPostRequest struct for UpgradeGiftPostRequest
type UpgradeGiftPostRequest struct {
...
type _UpgradeGiftPostRequest UpgradeGiftPostRequest
...
func (o UpgradeGiftPostRequest) MarshalJSON() ([]byte, error) {
...
func (o UpgradeGiftPostRequest) ToMap() (map[string]interface{}, error) {
...
func (o *UpgradeGiftPostRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varUpgradeGiftPostRequest := _UpgradeGiftPostRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpgradeGiftPostRequest)

	if err != nil {
		return err
	}

	*o = UpgradeGiftPostRequest(varUpgradeGiftPostRequest)

	return err
}

type NullableUpgradeGiftPostRequest struct {
	value *UpgradeGiftPostRequest
	isSet bool
}

func (v NullableUpgradeGiftPostRequest) Get() *UpgradeGiftPostRequest {
	return v.value
}

func (v *NullableUpgradeGiftPostRequest) Set(val *UpgradeGiftPostRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableUpgradeGiftPostRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableUpgradeGiftPostRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpgradeGiftPostRequest(val *UpgradeGiftPostRequest) *NullableUpgradeGiftPostRequest {
	return &NullableUpgradeGiftPostRequest{value: val, isSet: true}
}

func (v NullableUpgradeGiftPostRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpgradeGiftPostRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
