...
// checks if the UnbanChatMemberPostRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UnbanChatMemberPostRequest{}

// UnbanChatMemberPostRequest struct for UnbanChatMemberPostRequest
type UnbanChatMemberPostRequest struct {
	ChatId BanChatMemberPostRequestChatId `json:"chat_id"`
...
type _UnbanChatMemberPostRequest UnbanChatMemberPostRequest
...
func NewUnbanChatMemberPostRequest(chatId BanChatMemberPostRequestChatId, userId int32) *UnbanChatMemberPostRequest {
	this := UnbanChatMemberPostRequest{}
	this.ChatId = chatId
	this.UserId = userId
	return &this
}
...
func (o *UnbanChatMemberPostRequest) GetChatId() BanChatMemberPostRequestChatId {
	if o == nil {
		var ret BanChatMemberPostRequestChatId
		return ret
	}
...
func (o UnbanChatMemberPostRequest) MarshalJSON() ([]byte, error) {
...
func (o UnbanChatMemberPostRequest) ToMap() (map[string]interface{}, error) {
...
func (o *UnbanChatMemberPostRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varUnbanChatMemberPostRequest := _UnbanChatMemberPostRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUnbanChatMemberPostRequest)

	if err != nil {
		return err
	}

	*o = UnbanChatMemberPostRequest(varUnbanChatMemberPostRequest)

	return err
}

type NullableUnbanChatMemberPostRequest struct {
	value *UnbanChatMemberPostRequest
	isSet bool
}

func (v NullableUnbanChatMemberPostRequest) Get() *UnbanChatMemberPostRequest {
	return v.value
}

func (v *NullableUnbanChatMemberPostRequest) Set(val *UnbanChatMemberPostRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableUnbanChatMemberPostRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableUnbanChatMemberPostRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUnbanChatMemberPostRequest(val *UnbanChatMemberPostRequest) *NullableUnbanChatMemberPostRequest {
	return &NullableUnbanChatMemberPostRequest{value: val, isSet: true}
}

func (v NullableUnbanChatMemberPostRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUnbanChatMemberPostRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
