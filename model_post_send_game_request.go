...
// checks if the PostSendGameRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostSendGameRequest{}

// PostSendGameRequest struct for PostSendGameRequest
type PostSendGameRequest struct {
...
type _PostSendGameRequest PostSendGameRequest
...
func (o PostSendGameRequest) MarshalJSON() ([]byte, error) {
...
func (o PostSendGameRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PostSendGameRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPostSendGameRequest := _PostSendGameRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPostSendGameRequest)

	if err != nil {
		return err
	}

	*o = PostSendGameRequest(varPostSendGameRequest)

	return err
}

type NullablePostSendGameRequest struct {
	value *PostSendGameRequest
	isSet bool
}

func (v NullablePostSendGameRequest) Get() *PostSendGameRequest {
	return v.value
}

func (v *NullablePostSendGameRequest) Set(val *PostSendGameRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostSendGameRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostSendGameRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostSendGameRequest(val *PostSendGameRequest) *NullablePostSendGameRequest {
	return &NullablePostSendGameRequest{value: val, isSet: true}
}

func (v NullablePostSendGameRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostSendGameRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
