...
// checks if the PostRestrictChatMemberRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostRestrictChatMemberRequest{}

// PostRestrictChatMemberRequest struct for PostRestrictChatMemberRequest
type PostRestrictChatMemberRequest struct {
...
type _PostRestrictChatMemberRequest PostRestrictChatMemberRequest
...
func NewPostRestrictChatMemberRequest(chatId PostRestrictChatMemberRequestChatId, userId int32, permissions ChatPermissions) *PostRestrictChatMemberRequest {
	this := PostRestrictChatMemberRequest{}
	this.ChatId = chatId
	this.UserId = userId
...
func (o PostRestrictChatMemberRequest) MarshalJSON() ([]byte, error) {
...
func (o PostRestrictChatMemberRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PostRestrictChatMemberRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPostRestrictChatMemberRequest := _PostRestrictChatMemberRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPostRestrictChatMemberRequest)

	if err != nil {
		return err
	}

	*o = PostRestrictChatMemberRequest(varPostRestrictChatMemberRequest)

	return err
}

type NullablePostRestrictChatMemberRequest struct {
	value *PostRestrictChatMemberRequest
	isSet bool
}

func (v NullablePostRestrictChatMemberRequest) Get() *PostRestrictChatMemberRequest {
	return v.value
}

func (v *NullablePostRestrictChatMemberRequest) Set(val *PostRestrictChatMemberRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostRestrictChatMemberRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostRestrictChatMemberRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostRestrictChatMemberRequest(val *PostRestrictChatMemberRequest) *NullablePostRestrictChatMemberRequest {
	return &NullablePostRestrictChatMemberRequest{value: val, isSet: true}
}

func (v NullablePostRestrictChatMemberRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostRestrictChatMemberRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
