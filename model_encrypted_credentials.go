...
// checks if the EncryptedCredentials type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EncryptedCredentials{}
...
type _EncryptedCredentials EncryptedCredentials
...
func (o EncryptedCredentials) MarshalJSON() ([]byte, error) {
...
func (o EncryptedCredentials) ToMap() (map[string]interface{}, error) {
...
func (o *EncryptedCredentials) UnmarshalJSON(data []byte) (err error) {
	...
	varEncryptedCredentials := _EncryptedCredentials{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEncryptedCredentials)

	if err != nil {
		return err
	}

	*o = EncryptedCredentials(varEncryptedCredentials)

	return err
}

type NullableEncryptedCredentials struct {
	value *EncryptedCredentials
	isSet bool
}

func (v NullableEncryptedCredentials) Get() *EncryptedCredentials {
	return v.value
}

func (v *NullableEncryptedCredentials) Set(val *EncryptedCredentials) {
	v.value = val
	v.isSet = true
}

func (v NullableEncryptedCredentials) IsSet() bool {
	return v.isSet
}

func (v *NullableEncryptedCredentials) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEncryptedCredentials(val *EncryptedCredentials) *NullableEncryptedCredentials {
	return &NullableEncryptedCredentials{value: val, isSet: true}
}

func (v NullableEncryptedCredentials) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEncryptedCredentials) UnmarshalJSON(src []byte) error {
	v.isSet = true
