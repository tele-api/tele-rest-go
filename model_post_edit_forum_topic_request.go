...
// checks if the PostEditForumTopicRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostEditForumTopicRequest{}

// PostEditForumTopicRequest struct for PostEditForumTopicRequest
type PostEditForumTopicRequest struct {
...
type _PostEditForumTopicRequest PostEditForumTopicRequest
...
func NewPostEditForumTopicRequest(chatId PostRestrictChatMemberRequestChatId, messageThreadId int32) *PostEditForumTopicRequest {
	this := PostEditForumTopicRequest{}
	this.ChatId = chatId
...
func (o PostEditForumTopicRequest) MarshalJSON() ([]byte, error) {
...
func (o PostEditForumTopicRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PostEditForumTopicRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPostEditForumTopicRequest := _PostEditForumTopicRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPostEditForumTopicRequest)

	if err != nil {
		return err
	}

	*o = PostEditForumTopicRequest(varPostEditForumTopicRequest)

	return err
}

type NullablePostEditForumTopicRequest struct {
	value *PostEditForumTopicRequest
	isSet bool
}

func (v NullablePostEditForumTopicRequest) Get() *PostEditForumTopicRequest {
	return v.value
}

func (v *NullablePostEditForumTopicRequest) Set(val *PostEditForumTopicRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostEditForumTopicRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostEditForumTopicRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostEditForumTopicRequest(val *PostEditForumTopicRequest) *NullablePostEditForumTopicRequest {
	return &NullablePostEditForumTopicRequest{value: val, isSet: true}
}

func (v NullablePostEditForumTopicRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostEditForumTopicRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
