...
// checks if the SendGiftPostRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SendGiftPostRequest{}

// SendGiftPostRequest struct for SendGiftPostRequest
type SendGiftPostRequest struct {
	// Required if *chat\\_id* is not specified. Unique identifier of the target user who will receive the gift.
	UserId *int32 `json:"user_id,omitempty"`
	ChatId *SendGiftPostRequestChatId `json:"chat_id,omitempty"`
...
type _SendGiftPostRequest SendGiftPostRequest
...
func (o *SendGiftPostRequest) GetChatId() SendGiftPostRequestChatId {
	if o == nil || IsNil(o.ChatId) {
		var ret SendGiftPostRequestChatId
		return ret
	}
	return *o.ChatId
}
...
// SetChatId gets a reference to the given SendGiftPostRequestChatId and assigns it to the ChatId field.
...
func (o SendGiftPostRequest) MarshalJSON() ([]byte, error) {
...
func (o SendGiftPostRequest) ToMap() (map[string]interface{}, error) {
...
func (o *SendGiftPostRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varSendGiftPostRequest := _SendGiftPostRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSendGiftPostRequest)

	if err != nil {
		return err
	}

	*o = SendGiftPostRequest(varSendGiftPostRequest)

	return err
}

type NullableSendGiftPostRequest struct {
	value *SendGiftPostRequest
	isSet bool
}

func (v NullableSendGiftPostRequest) Get() *SendGiftPostRequest {
	return v.value
}

func (v *NullableSendGiftPostRequest) Set(val *SendGiftPostRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableSendGiftPostRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableSendGiftPostRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSendGiftPostRequest(val *SendGiftPostRequest) *NullableSendGiftPostRequest {
	return &NullableSendGiftPostRequest{value: val, isSet: true}
}

func (v NullableSendGiftPostRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSendGiftPostRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
