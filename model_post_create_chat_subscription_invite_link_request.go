...
// checks if the PostCreateChatSubscriptionInviteLinkRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostCreateChatSubscriptionInviteLinkRequest{}

// PostCreateChatSubscriptionInviteLinkRequest struct for PostCreateChatSubscriptionInviteLinkRequest
type PostCreateChatSubscriptionInviteLinkRequest struct {
	ChatId PostCreateChatSubscriptionInviteLinkRequestChatId `json:"chat_id"`
...
type _PostCreateChatSubscriptionInviteLinkRequest PostCreateChatSubscriptionInviteLinkRequest
...
func NewPostCreateChatSubscriptionInviteLinkRequest(chatId PostCreateChatSubscriptionInviteLinkRequestChatId, subscriptionPeriod int32, subscriptionPrice int32) *PostCreateChatSubscriptionInviteLinkRequest {
	this := PostCreateChatSubscriptionInviteLinkRequest{}
	this.ChatId = chatId
...
func (o *PostCreateChatSubscriptionInviteLinkRequest) GetChatId() PostCreateChatSubscriptionInviteLinkRequestChatId {
	if o == nil {
		var ret PostCreateChatSubscriptionInviteLinkRequestChatId
		return ret
	}
...
func (o PostCreateChatSubscriptionInviteLinkRequest) MarshalJSON() ([]byte, error) {
...
func (o PostCreateChatSubscriptionInviteLinkRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PostCreateChatSubscriptionInviteLinkRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPostCreateChatSubscriptionInviteLinkRequest := _PostCreateChatSubscriptionInviteLinkRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPostCreateChatSubscriptionInviteLinkRequest)

	if err != nil {
		return err
	}

	*o = PostCreateChatSubscriptionInviteLinkRequest(varPostCreateChatSubscriptionInviteLinkRequest)

	return err
}

type NullablePostCreateChatSubscriptionInviteLinkRequest struct {
	value *PostCreateChatSubscriptionInviteLinkRequest
	isSet bool
}

func (v NullablePostCreateChatSubscriptionInviteLinkRequest) Get() *PostCreateChatSubscriptionInviteLinkRequest {
	return v.value
}

func (v *NullablePostCreateChatSubscriptionInviteLinkRequest) Set(val *PostCreateChatSubscriptionInviteLinkRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostCreateChatSubscriptionInviteLinkRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostCreateChatSubscriptionInviteLinkRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostCreateChatSubscriptionInviteLinkRequest(val *PostCreateChatSubscriptionInviteLinkRequest) *NullablePostCreateChatSubscriptionInviteLinkRequest {
	return &NullablePostCreateChatSubscriptionInviteLinkRequest{value: val, isSet: true}
}

func (v NullablePostCreateChatSubscriptionInviteLinkRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostCreateChatSubscriptionInviteLinkRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
