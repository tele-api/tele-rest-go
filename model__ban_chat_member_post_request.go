...
// checks if the BanChatMemberPostRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BanChatMemberPostRequest{}

// BanChatMemberPostRequest struct for BanChatMemberPostRequest
type BanChatMemberPostRequest struct {
...
type _BanChatMemberPostRequest BanChatMemberPostRequest
...
func (o BanChatMemberPostRequest) MarshalJSON() ([]byte, error) {
...
func (o BanChatMemberPostRequest) ToMap() (map[string]interface{}, error) {
...
func (o *BanChatMemberPostRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varBanChatMemberPostRequest := _BanChatMemberPostRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBanChatMemberPostRequest)

	if err != nil {
		return err
	}

	*o = BanChatMemberPostRequest(varBanChatMemberPostRequest)

	return err
}

type NullableBanChatMemberPostRequest struct {
	value *BanChatMemberPostRequest
	isSet bool
}

func (v NullableBanChatMemberPostRequest) Get() *BanChatMemberPostRequest {
	return v.value
}

func (v *NullableBanChatMemberPostRequest) Set(val *BanChatMemberPostRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBanChatMemberPostRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBanChatMemberPostRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBanChatMemberPostRequest(val *BanChatMemberPostRequest) *NullableBanChatMemberPostRequest {
	return &NullableBanChatMemberPostRequest{value: val, isSet: true}
}

func (v NullableBanChatMemberPostRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBanChatMemberPostRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
