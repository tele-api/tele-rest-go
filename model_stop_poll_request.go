...
// checks if the StopPollRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StopPollRequest{}

// StopPollRequest Request parameters for stopPoll
...
type _StopPollRequest StopPollRequest
...
func (o StopPollRequest) MarshalJSON() ([]byte, error) {
...
func (o StopPollRequest) ToMap() (map[string]interface{}, error) {
...
func (o *StopPollRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varStopPollRequest := _StopPollRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varStopPollRequest)

	if err != nil {
		return err
	}

	*o = StopPollRequest(varStopPollRequest)

	return err
}

type NullableStopPollRequest struct {
	value *StopPollRequest
	isSet bool
}

func (v NullableStopPollRequest) Get() *StopPollRequest {
	return v.value
}

func (v *NullableStopPollRequest) Set(val *StopPollRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableStopPollRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableStopPollRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStopPollRequest(val *StopPollRequest) *NullableStopPollRequest {
	return &NullableStopPollRequest{value: val, isSet: true}
}

func (v NullableStopPollRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStopPollRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
