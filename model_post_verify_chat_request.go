...
// checks if the PostVerifyChatRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostVerifyChatRequest{}

// PostVerifyChatRequest struct for PostVerifyChatRequest
type PostVerifyChatRequest struct {
	ChatId PostSendMessageRequestChatId `json:"chat_id"`
	// Custom description for the verification; 0-70 characters. Must be empty if the organization isn't allowed to provide a custom verification description.
	CustomDescription *string `json:"custom_description,omitempty"`
}

type _PostVerifyChatRequest PostVerifyChatRequest
...
func (o PostVerifyChatRequest) MarshalJSON() ([]byte, error) {
...
func (o PostVerifyChatRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PostVerifyChatRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPostVerifyChatRequest := _PostVerifyChatRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPostVerifyChatRequest)

	if err != nil {
		return err
	}

	*o = PostVerifyChatRequest(varPostVerifyChatRequest)

	return err
}

type NullablePostVerifyChatRequest struct {
	value *PostVerifyChatRequest
	isSet bool
}

func (v NullablePostVerifyChatRequest) Get() *PostVerifyChatRequest {
	return v.value
}

func (v *NullablePostVerifyChatRequest) Set(val *PostVerifyChatRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostVerifyChatRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostVerifyChatRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostVerifyChatRequest(val *PostVerifyChatRequest) *NullablePostVerifyChatRequest {
	return &NullablePostVerifyChatRequest{value: val, isSet: true}
}

func (v NullablePostVerifyChatRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostVerifyChatRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
