...
// checks if the InaccessibleMessage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InaccessibleMessage{}
...
type _InaccessibleMessage InaccessibleMessage
...
func (o InaccessibleMessage) MarshalJSON() ([]byte, error) {
...
func (o InaccessibleMessage) ToMap() (map[string]interface{}, error) {
...
func (o *InaccessibleMessage) UnmarshalJSON(data []byte) (err error) {
	...
	varInaccessibleMessage := _InaccessibleMessage{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varInaccessibleMessage)

	if err != nil {
		return err
	}

	*o = InaccessibleMessage(varInaccessibleMessage)

	return err
}

type NullableInaccessibleMessage struct {
	value *InaccessibleMessage
	isSet bool
}

func (v NullableInaccessibleMessage) Get() *InaccessibleMessage {
	return v.value
}

func (v *NullableInaccessibleMessage) Set(val *InaccessibleMessage) {
	v.value = val
	v.isSet = true
}

func (v NullableInaccessibleMessage) IsSet() bool {
	return v.isSet
}

func (v *NullableInaccessibleMessage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInaccessibleMessage(val *InaccessibleMessage) *NullableInaccessibleMessage {
	return &NullableInaccessibleMessage{value: val, isSet: true}
}

func (v NullableInaccessibleMessage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInaccessibleMessage) UnmarshalJSON(src []byte) error {
	v.isSet = true
