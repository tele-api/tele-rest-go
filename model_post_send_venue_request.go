...
// checks if the PostSendVenueRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostSendVenueRequest{}

// PostSendVenueRequest struct for PostSendVenueRequest
type PostSendVenueRequest struct {
...
type _PostSendVenueRequest PostSendVenueRequest
...
func (o PostSendVenueRequest) MarshalJSON() ([]byte, error) {
...
func (o PostSendVenueRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PostSendVenueRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPostSendVenueRequest := _PostSendVenueRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPostSendVenueRequest)

	if err != nil {
		return err
	}

	*o = PostSendVenueRequest(varPostSendVenueRequest)

	return err
}

type NullablePostSendVenueRequest struct {
	value *PostSendVenueRequest
	isSet bool
}

func (v NullablePostSendVenueRequest) Get() *PostSendVenueRequest {
	return v.value
}

func (v *NullablePostSendVenueRequest) Set(val *PostSendVenueRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostSendVenueRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostSendVenueRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostSendVenueRequest(val *PostSendVenueRequest) *NullablePostSendVenueRequest {
	return &NullablePostSendVenueRequest{value: val, isSet: true}
}

func (v NullablePostSendVenueRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostSendVenueRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
