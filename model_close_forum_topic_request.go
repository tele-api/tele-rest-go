...
// checks if the CloseForumTopicRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloseForumTopicRequest{}

// CloseForumTopicRequest Request parameters for closeForumTopic
...
type _CloseForumTopicRequest CloseForumTopicRequest
...
func (o CloseForumTopicRequest) MarshalJSON() ([]byte, error) {
...
func (o CloseForumTopicRequest) ToMap() (map[string]interface{}, error) {
...
func (o *CloseForumTopicRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCloseForumTopicRequest := _CloseForumTopicRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCloseForumTopicRequest)

	if err != nil {
		return err
	}

	*o = CloseForumTopicRequest(varCloseForumTopicRequest)

	return err
}

type NullableCloseForumTopicRequest struct {
	value *CloseForumTopicRequest
	isSet bool
}

func (v NullableCloseForumTopicRequest) Get() *CloseForumTopicRequest {
	return v.value
}

func (v *NullableCloseForumTopicRequest) Set(val *CloseForumTopicRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCloseForumTopicRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCloseForumTopicRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloseForumTopicRequest(val *CloseForumTopicRequest) *NullableCloseForumTopicRequest {
	return &NullableCloseForumTopicRequest{value: val, isSet: true}
}

func (v NullableCloseForumTopicRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloseForumTopicRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
