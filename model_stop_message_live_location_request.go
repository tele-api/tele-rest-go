...
// checks if the StopMessageLiveLocationRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StopMessageLiveLocationRequest{}

// StopMessageLiveLocationRequest Request parameters for stopMessageLiveLocation
...
func NewStopMessageLiveLocationRequest() *StopMessageLiveLocationRequest {
	this := StopMessageLiveLocationRequest{}
	return &this
}
...
func (o StopMessageLiveLocationRequest) MarshalJSON() ([]byte, error) {
...
func (o StopMessageLiveLocationRequest) ToMap() (map[string]interface{}, error) {
...
type NullableStopMessageLiveLocationRequest struct {
	value *StopMessageLiveLocationRequest
	isSet bool
}

func (v NullableStopMessageLiveLocationRequest) Get() *StopMessageLiveLocationRequest {
	return v.value
}

func (v *NullableStopMessageLiveLocationRequest) Set(val *StopMessageLiveLocationRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableStopMessageLiveLocationRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableStopMessageLiveLocationRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStopMessageLiveLocationRequest(val *StopMessageLiveLocationRequest) *NullableStopMessageLiveLocationRequest {
	return &NullableStopMessageLiveLocationRequest{value: val, isSet: true}
}

func (v NullableStopMessageLiveLocationRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStopMessageLiveLocationRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
