...
// checks if the RestrictChatMemberPostRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RestrictChatMemberPostRequest{}

// RestrictChatMemberPostRequest struct for RestrictChatMemberPostRequest
type RestrictChatMemberPostRequest struct {
...
type _RestrictChatMemberPostRequest RestrictChatMemberPostRequest
...
func NewRestrictChatMemberPostRequest(chatId RestrictChatMemberPostRequestChatId, userId int32, permissions ChatPermissions) *RestrictChatMemberPostRequest {
	this := RestrictChatMemberPostRequest{}
	this.ChatId = chatId
	this.UserId = userId
...
func (o RestrictChatMemberPostRequest) MarshalJSON() ([]byte, error) {
...
func (o RestrictChatMemberPostRequest) ToMap() (map[string]interface{}, error) {
...
func (o *RestrictChatMemberPostRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varRestrictChatMemberPostRequest := _RestrictChatMemberPostRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRestrictChatMemberPostRequest)

	if err != nil {
		return err
	}

	*o = RestrictChatMemberPostRequest(varRestrictChatMemberPostRequest)

	return err
}

type NullableRestrictChatMemberPostRequest struct {
	value *RestrictChatMemberPostRequest
	isSet bool
}

func (v NullableRestrictChatMemberPostRequest) Get() *RestrictChatMemberPostRequest {
	return v.value
}

func (v *NullableRestrictChatMemberPostRequest) Set(val *RestrictChatMemberPostRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableRestrictChatMemberPostRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableRestrictChatMemberPostRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRestrictChatMemberPostRequest(val *RestrictChatMemberPostRequest) *NullableRestrictChatMemberPostRequest {
	return &NullableRestrictChatMemberPostRequest{value: val, isSet: true}
}

func (v NullableRestrictChatMemberPostRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRestrictChatMemberPostRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
