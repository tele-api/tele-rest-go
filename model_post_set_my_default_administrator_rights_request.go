...
// checks if the PostSetMyDefaultAdministratorRightsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostSetMyDefaultAdministratorRightsRequest{}

// PostSetMyDefaultAdministratorRightsRequest struct for PostSetMyDefaultAdministratorRightsRequest
type PostSetMyDefaultAdministratorRightsRequest struct {
...
func NewPostSetMyDefaultAdministratorRightsRequest() *PostSetMyDefaultAdministratorRightsRequest {
	this := PostSetMyDefaultAdministratorRightsRequest{}
	return &this
}
...
func (o PostSetMyDefaultAdministratorRightsRequest) MarshalJSON() ([]byte, error) {
...
func (o PostSetMyDefaultAdministratorRightsRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePostSetMyDefaultAdministratorRightsRequest struct {
	value *PostSetMyDefaultAdministratorRightsRequest
	isSet bool
}

func (v NullablePostSetMyDefaultAdministratorRightsRequest) Get() *PostSetMyDefaultAdministratorRightsRequest {
	return v.value
}

func (v *NullablePostSetMyDefaultAdministratorRightsRequest) Set(val *PostSetMyDefaultAdministratorRightsRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostSetMyDefaultAdministratorRightsRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostSetMyDefaultAdministratorRightsRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostSetMyDefaultAdministratorRightsRequest(val *PostSetMyDefaultAdministratorRightsRequest) *NullablePostSetMyDefaultAdministratorRightsRequest {
	return &NullablePostSetMyDefaultAdministratorRightsRequest{value: val, isSet: true}
}

func (v NullablePostSetMyDefaultAdministratorRightsRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostSetMyDefaultAdministratorRightsRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
