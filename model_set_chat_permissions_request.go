...
// checks if the SetChatPermissionsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SetChatPermissionsRequest{}

// SetChatPermissionsRequest Request parameters for setChatPermissions
...
type _SetChatPermissionsRequest SetChatPermissionsRequest
...
func NewSetChatPermissionsRequest(chatId BotCommandScopeChatChatId, permissions ChatPermissions) *SetChatPermissionsRequest {
	this := SetChatPermissionsRequest{}
	this.ChatId = chatId
...
func (o SetChatPermissionsRequest) MarshalJSON() ([]byte, error) {
...
func (o SetChatPermissionsRequest) ToMap() (map[string]interface{}, error) {
...
func (o *SetChatPermissionsRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varSetChatPermissionsRequest := _SetChatPermissionsRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSetChatPermissionsRequest)

	if err != nil {
		return err
	}

	*o = SetChatPermissionsRequest(varSetChatPermissionsRequest)

	return err
}

type NullableSetChatPermissionsRequest struct {
	value *SetChatPermissionsRequest
	isSet bool
}

func (v NullableSetChatPermissionsRequest) Get() *SetChatPermissionsRequest {
	return v.value
}

func (v *NullableSetChatPermissionsRequest) Set(val *SetChatPermissionsRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableSetChatPermissionsRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableSetChatPermissionsRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSetChatPermissionsRequest(val *SetChatPermissionsRequest) *NullableSetChatPermissionsRequest {
	return &NullableSetChatPermissionsRequest{value: val, isSet: true}
}

func (v NullableSetChatPermissionsRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSetChatPermissionsRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
