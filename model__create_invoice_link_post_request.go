...
// checks if the CreateInvoiceLinkPostRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateInvoiceLinkPostRequest{}

// CreateInvoiceLinkPostRequest struct for CreateInvoiceLinkPostRequest
type CreateInvoiceLinkPostRequest struct {
...
type _CreateInvoiceLinkPostRequest CreateInvoiceLinkPostRequest
...
func NewCreateInvoiceLinkPostRequest(title string, description string, payload string, currency string, prices []LabeledPrice) *CreateInvoiceLinkPostRequest {
	this := CreateInvoiceLinkPostRequest{}
	this.Title = title
...
func (o CreateInvoiceLinkPostRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateInvoiceLinkPostRequest) ToMap() (map[string]interface{}, error) {
...
func (o *CreateInvoiceLinkPostRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateInvoiceLinkPostRequest := _CreateInvoiceLinkPostRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateInvoiceLinkPostRequest)

	if err != nil {
		return err
	}

	*o = CreateInvoiceLinkPostRequest(varCreateInvoiceLinkPostRequest)

	return err
}

type NullableCreateInvoiceLinkPostRequest struct {
	value *CreateInvoiceLinkPostRequest
	isSet bool
}

func (v NullableCreateInvoiceLinkPostRequest) Get() *CreateInvoiceLinkPostRequest {
	return v.value
}

func (v *NullableCreateInvoiceLinkPostRequest) Set(val *CreateInvoiceLinkPostRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateInvoiceLinkPostRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateInvoiceLinkPostRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateInvoiceLinkPostRequest(val *CreateInvoiceLinkPostRequest) *NullableCreateInvoiceLinkPostRequest {
	return &NullableCreateInvoiceLinkPostRequest{value: val, isSet: true}
}

func (v NullableCreateInvoiceLinkPostRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateInvoiceLinkPostRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
