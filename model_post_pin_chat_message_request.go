...
// checks if the PostPinChatMessageRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostPinChatMessageRequest{}

// PostPinChatMessageRequest struct for PostPinChatMessageRequest
type PostPinChatMessageRequest struct {
...
type _PostPinChatMessageRequest PostPinChatMessageRequest
...
func NewPostPinChatMessageRequest(chatId PostSendMessageRequestChatId, messageId int32) *PostPinChatMessageRequest {
	this := PostPinChatMessageRequest{}
	this.ChatId = chatId
...
func (o PostPinChatMessageRequest) MarshalJSON() ([]byte, error) {
...
func (o PostPinChatMessageRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PostPinChatMessageRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPostPinChatMessageRequest := _PostPinChatMessageRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPostPinChatMessageRequest)

	if err != nil {
		return err
	}

	*o = PostPinChatMessageRequest(varPostPinChatMessageRequest)

	return err
}

type NullablePostPinChatMessageRequest struct {
	value *PostPinChatMessageRequest
	isSet bool
}

func (v NullablePostPinChatMessageRequest) Get() *PostPinChatMessageRequest {
	return v.value
}

func (v *NullablePostPinChatMessageRequest) Set(val *PostPinChatMessageRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostPinChatMessageRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostPinChatMessageRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostPinChatMessageRequest(val *PostPinChatMessageRequest) *NullablePostPinChatMessageRequest {
	return &NullablePostPinChatMessageRequest{value: val, isSet: true}
}

func (v NullablePostPinChatMessageRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostPinChatMessageRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
