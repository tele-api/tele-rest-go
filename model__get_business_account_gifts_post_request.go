...
// checks if the GetBusinessAccountGiftsPostRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetBusinessAccountGiftsPostRequest{}

// GetBusinessAccountGiftsPostRequest struct for GetBusinessAccountGiftsPostRequest
type GetBusinessAccountGiftsPostRequest struct {
...
type _GetBusinessAccountGiftsPostRequest GetBusinessAccountGiftsPostRequest
...
func NewGetBusinessAccountGiftsPostRequest(businessConnectionId string) *GetBusinessAccountGiftsPostRequest {
	this := GetBusinessAccountGiftsPostRequest{}
...
func (o GetBusinessAccountGiftsPostRequest) MarshalJSON() ([]byte, error) {
...
func (o GetBusinessAccountGiftsPostRequest) ToMap() (map[string]interface{}, error) {
...
func (o *GetBusinessAccountGiftsPostRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varGetBusinessAccountGiftsPostRequest := _GetBusinessAccountGiftsPostRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetBusinessAccountGiftsPostRequest)

	if err != nil {
		return err
	}

	*o = GetBusinessAccountGiftsPostRequest(varGetBusinessAccountGiftsPostRequest)

	return err
}

type NullableGetBusinessAccountGiftsPostRequest struct {
	value *GetBusinessAccountGiftsPostRequest
	isSet bool
}

func (v NullableGetBusinessAccountGiftsPostRequest) Get() *GetBusinessAccountGiftsPostRequest {
	return v.value
}

func (v *NullableGetBusinessAccountGiftsPostRequest) Set(val *GetBusinessAccountGiftsPostRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableGetBusinessAccountGiftsPostRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableGetBusinessAccountGiftsPostRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetBusinessAccountGiftsPostRequest(val *GetBusinessAccountGiftsPostRequest) *NullableGetBusinessAccountGiftsPostRequest {
	return &NullableGetBusinessAccountGiftsPostRequest{value: val, isSet: true}
}

func (v NullableGetBusinessAccountGiftsPostRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetBusinessAccountGiftsPostRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
