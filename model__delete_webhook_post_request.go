...
// checks if the DeleteWebhookPostRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteWebhookPostRequest{}

// DeleteWebhookPostRequest struct for DeleteWebhookPostRequest
type DeleteWebhookPostRequest struct {
...
func (o DeleteWebhookPostRequest) MarshalJSON() ([]byte, error) {
...
func (o DeleteWebhookPostRequest) ToMap() (map[string]interface{}, error) {
...
type NullableDeleteWebhookPostRequest struct {
	value *DeleteWebhookPostRequest
	isSet bool
}

func (v NullableDeleteWebhookPostRequest) Get() *DeleteWebhookPostRequest {
	return v.value
}

func (v *NullableDeleteWebhookPostRequest) Set(val *DeleteWebhookPostRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteWebhookPostRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteWebhookPostRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteWebhookPostRequest(val *DeleteWebhookPostRequest) *NullableDeleteWebhookPostRequest {
	return &NullableDeleteWebhookPostRequest{value: val, isSet: true}
}

func (v NullableDeleteWebhookPostRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteWebhookPostRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
