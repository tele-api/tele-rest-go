...
// checks if the ForwardMessagePostRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ForwardMessagePostRequest{}

// ForwardMessagePostRequest struct for ForwardMessagePostRequest
type ForwardMessagePostRequest struct {
...
type _ForwardMessagePostRequest ForwardMessagePostRequest
...
func NewForwardMessagePostRequest(chatId SendMessagePostRequestChatId, fromChatId ForwardMessagePostRequestFromChatId, messageId int32) *ForwardMessagePostRequest {
	this := ForwardMessagePostRequest{}
	this.ChatId = chatId
...
func (o ForwardMessagePostRequest) MarshalJSON() ([]byte, error) {
...
func (o ForwardMessagePostRequest) ToMap() (map[string]interface{}, error) {
...
func (o *ForwardMessagePostRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varForwardMessagePostRequest := _ForwardMessagePostRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varForwardMessagePostRequest)

	if err != nil {
		return err
	}

	*o = ForwardMessagePostRequest(varForwardMessagePostRequest)

	return err
}

type NullableForwardMessagePostRequest struct {
	value *ForwardMessagePostRequest
	isSet bool
}

func (v NullableForwardMessagePostRequest) Get() *ForwardMessagePostRequest {
	return v.value
}

func (v *NullableForwardMessagePostRequest) Set(val *ForwardMessagePostRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableForwardMessagePostRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableForwardMessagePostRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableForwardMessagePostRequest(val *ForwardMessagePostRequest) *NullableForwardMessagePostRequest {
	return &NullableForwardMessagePostRequest{value: val, isSet: true}
}

func (v NullableForwardMessagePostRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableForwardMessagePostRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
