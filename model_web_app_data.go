...
// checks if the WebAppData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebAppData{}
...
func (o WebAppData) MarshalJSON() ([]byte, error) {
...
func (o WebAppData) ToMap() (map[string]interface{}, error) {
...
func (o *WebAppData) UnmarshalJSON(data []byte) (err error) {
	...
	varWebAppData := _WebAppData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varWebAppData)

	if err != nil {
		return err
	}

	*o = WebAppData(varWebAppData)

	return err
}

type NullableWebAppData struct {
	value *WebAppData
	isSet bool
}

func (v NullableWebAppData) Get() *WebAppData {
	return v.value
}

func (v *NullableWebAppData) Set(val *WebAppData) {
	v.value = val
	v.isSet = true
}

func (v NullableWebAppData) IsSet() bool {
	return v.isSet
}

func (v *NullableWebAppData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebAppData(val *WebAppData) *NullableWebAppData {
	return &NullableWebAppData{value: val, isSet: true}
}

func (v NullableWebAppData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebAppData) UnmarshalJSON(src []byte) error {
	v.isSet = true
