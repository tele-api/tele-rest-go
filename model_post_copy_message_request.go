...
// checks if the PostCopyMessageRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostCopyMessageRequest{}

// PostCopyMessageRequest struct for PostCopyMessageRequest
type PostCopyMessageRequest struct {
...
type _PostCopyMessageRequest PostCopyMessageRequest
...
func (o PostCopyMessageRequest) MarshalJSON() ([]byte, error) {
...
func (o PostCopyMessageRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PostCopyMessageRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPostCopyMessageRequest := _PostCopyMessageRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPostCopyMessageRequest)

	if err != nil {
		return err
	}

	*o = PostCopyMessageRequest(varPostCopyMessageRequest)

	return err
}

type NullablePostCopyMessageRequest struct {
	value *PostCopyMessageRequest
	isSet bool
}

func (v NullablePostCopyMessageRequest) Get() *PostCopyMessageRequest {
	return v.value
}

func (v *NullablePostCopyMessageRequest) Set(val *PostCopyMessageRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostCopyMessageRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostCopyMessageRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostCopyMessageRequest(val *PostCopyMessageRequest) *NullablePostCopyMessageRequest {
	return &NullablePostCopyMessageRequest{value: val, isSet: true}
}

func (v NullablePostCopyMessageRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostCopyMessageRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
