...
// checks if the SavePreparedInlineMessagePostRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SavePreparedInlineMessagePostRequest{}

// SavePreparedInlineMessagePostRequest struct for SavePreparedInlineMessagePostRequest
type SavePreparedInlineMessagePostRequest struct {
...
type _SavePreparedInlineMessagePostRequest SavePreparedInlineMessagePostRequest
...
func NewSavePreparedInlineMessagePostRequest(userId int32, result InlineQueryResult) *SavePreparedInlineMessagePostRequest {
	this := SavePreparedInlineMessagePostRequest{}
	this.UserId = userId
	this.Result = result
	return &this
}
...
func (o SavePreparedInlineMessagePostRequest) MarshalJSON() ([]byte, error) {
...
func (o SavePreparedInlineMessagePostRequest) ToMap() (map[string]interface{}, error) {
...
func (o *SavePreparedInlineMessagePostRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varSavePreparedInlineMessagePostRequest := _SavePreparedInlineMessagePostRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSavePreparedInlineMessagePostRequest)

	if err != nil {
		return err
	}

	*o = SavePreparedInlineMessagePostRequest(varSavePreparedInlineMessagePostRequest)

	return err
}

type NullableSavePreparedInlineMessagePostRequest struct {
	value *SavePreparedInlineMessagePostRequest
	isSet bool
}

func (v NullableSavePreparedInlineMessagePostRequest) Get() *SavePreparedInlineMessagePostRequest {
	return v.value
}

func (v *NullableSavePreparedInlineMessagePostRequest) Set(val *SavePreparedInlineMessagePostRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableSavePreparedInlineMessagePostRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableSavePreparedInlineMessagePostRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSavePreparedInlineMessagePostRequest(val *SavePreparedInlineMessagePostRequest) *NullableSavePreparedInlineMessagePostRequest {
	return &NullableSavePreparedInlineMessagePostRequest{value: val, isSet: true}
}

func (v NullableSavePreparedInlineMessagePostRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSavePreparedInlineMessagePostRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
