...
// checks if the PostGetGameHighScoresRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostGetGameHighScoresRequest{}

// PostGetGameHighScoresRequest struct for PostGetGameHighScoresRequest
type PostGetGameHighScoresRequest struct {
	// Target user id
...
type _PostGetGameHighScoresRequest PostGetGameHighScoresRequest
...
func NewPostGetGameHighScoresRequest(userId int32) *PostGetGameHighScoresRequest {
	this := PostGetGameHighScoresRequest{}
	this.UserId = userId
	return &this
}
...
func (o PostGetGameHighScoresRequest) MarshalJSON() ([]byte, error) {
...
func (o PostGetGameHighScoresRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PostGetGameHighScoresRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPostGetGameHighScoresRequest := _PostGetGameHighScoresRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPostGetGameHighScoresRequest)

	if err != nil {
		return err
	}

	*o = PostGetGameHighScoresRequest(varPostGetGameHighScoresRequest)

	return err
}

type NullablePostGetGameHighScoresRequest struct {
	value *PostGetGameHighScoresRequest
	isSet bool
}

func (v NullablePostGetGameHighScoresRequest) Get() *PostGetGameHighScoresRequest {
	return v.value
}

func (v *NullablePostGetGameHighScoresRequest) Set(val *PostGetGameHighScoresRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostGetGameHighScoresRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostGetGameHighScoresRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostGetGameHighScoresRequest(val *PostGetGameHighScoresRequest) *NullablePostGetGameHighScoresRequest {
	return &NullablePostGetGameHighScoresRequest{value: val, isSet: true}
}

func (v NullablePostGetGameHighScoresRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostGetGameHighScoresRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
