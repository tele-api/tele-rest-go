...
// checks if the PromoteChatMemberPostRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PromoteChatMemberPostRequest{}

// PromoteChatMemberPostRequest struct for PromoteChatMemberPostRequest
type PromoteChatMemberPostRequest struct {
...
type _PromoteChatMemberPostRequest PromoteChatMemberPostRequest
...
func NewPromoteChatMemberPostRequest(chatId SendMessagePostRequestChatId, userId int32) *PromoteChatMemberPostRequest {
	this := PromoteChatMemberPostRequest{}
	this.ChatId = chatId
	this.UserId = userId
	return &this
}
...
func (o PromoteChatMemberPostRequest) MarshalJSON() ([]byte, error) {
...
func (o PromoteChatMemberPostRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PromoteChatMemberPostRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPromoteChatMemberPostRequest := _PromoteChatMemberPostRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPromoteChatMemberPostRequest)

	if err != nil {
		return err
	}

	*o = PromoteChatMemberPostRequest(varPromoteChatMemberPostRequest)

	return err
}

type NullablePromoteChatMemberPostRequest struct {
	value *PromoteChatMemberPostRequest
	isSet bool
}

func (v NullablePromoteChatMemberPostRequest) Get() *PromoteChatMemberPostRequest {
	return v.value
}

func (v *NullablePromoteChatMemberPostRequest) Set(val *PromoteChatMemberPostRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePromoteChatMemberPostRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePromoteChatMemberPostRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePromoteChatMemberPostRequest(val *PromoteChatMemberPostRequest) *NullablePromoteChatMemberPostRequest {
	return &NullablePromoteChatMemberPostRequest{value: val, isSet: true}
}

func (v NullablePromoteChatMemberPostRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePromoteChatMemberPostRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
