...
// checks if the PostBanChatMemberRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostBanChatMemberRequest{}

// PostBanChatMemberRequest struct for PostBanChatMemberRequest
type PostBanChatMemberRequest struct {
...
type _PostBanChatMemberRequest PostBanChatMemberRequest
...
func (o PostBanChatMemberRequest) MarshalJSON() ([]byte, error) {
...
func (o PostBanChatMemberRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PostBanChatMemberRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPostBanChatMemberRequest := _PostBanChatMemberRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPostBanChatMemberRequest)

	if err != nil {
		return err
	}

	*o = PostBanChatMemberRequest(varPostBanChatMemberRequest)

	return err
}

type NullablePostBanChatMemberRequest struct {
	value *PostBanChatMemberRequest
	isSet bool
}

func (v NullablePostBanChatMemberRequest) Get() *PostBanChatMemberRequest {
	return v.value
}

func (v *NullablePostBanChatMemberRequest) Set(val *PostBanChatMemberRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostBanChatMemberRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostBanChatMemberRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostBanChatMemberRequest(val *PostBanChatMemberRequest) *NullablePostBanChatMemberRequest {
	return &NullablePostBanChatMemberRequest{value: val, isSet: true}
}

func (v NullablePostBanChatMemberRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostBanChatMemberRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
