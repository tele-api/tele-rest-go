...
// checks if the DeleteWebhookResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteWebhookResponse{}
...
type _DeleteWebhookResponse DeleteWebhookResponse
...
func (o *DeleteWebhookResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varDeleteWebhookResponse := _DeleteWebhookResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDeleteWebhookResponse)

	if err != nil {
		return err
	}

	*o = DeleteWebhookResponse(varDeleteWebhookResponse)
