...
// checks if the PostEditChatInviteLinkRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostEditChatInviteLinkRequest{}

// PostEditChatInviteLinkRequest struct for PostEditChatInviteLinkRequest
type PostEditChatInviteLinkRequest struct {
...
type _PostEditChatInviteLinkRequest PostEditChatInviteLinkRequest
...
func NewPostEditChatInviteLinkRequest(chatId PostSendMessageRequestChatId, inviteLink string) *PostEditChatInviteLinkRequest {
	this := PostEditChatInviteLinkRequest{}
	this.ChatId = chatId
...
func (o PostEditChatInviteLinkRequest) MarshalJSON() ([]byte, error) {
...
func (o PostEditChatInviteLinkRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PostEditChatInviteLinkRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPostEditChatInviteLinkRequest := _PostEditChatInviteLinkRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPostEditChatInviteLinkRequest)

	if err != nil {
		return err
	}

	*o = PostEditChatInviteLinkRequest(varPostEditChatInviteLinkRequest)

	return err
}

type NullablePostEditChatInviteLinkRequest struct {
	value *PostEditChatInviteLinkRequest
	isSet bool
}

func (v NullablePostEditChatInviteLinkRequest) Get() *PostEditChatInviteLinkRequest {
	return v.value
}

func (v *NullablePostEditChatInviteLinkRequest) Set(val *PostEditChatInviteLinkRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostEditChatInviteLinkRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostEditChatInviteLinkRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostEditChatInviteLinkRequest(val *PostEditChatInviteLinkRequest) *NullablePostEditChatInviteLinkRequest {
	return &NullablePostEditChatInviteLinkRequest{value: val, isSet: true}
}

func (v NullablePostEditChatInviteLinkRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostEditChatInviteLinkRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
