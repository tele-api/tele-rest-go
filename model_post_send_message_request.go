...
// checks if the PostSendMessageRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostSendMessageRequest{}

// PostSendMessageRequest struct for PostSendMessageRequest
...
type _PostSendMessageRequest PostSendMessageRequest
...
func (o PostSendMessageRequest) MarshalJSON() ([]byte, error) {
...
func (o PostSendMessageRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PostSendMessageRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPostSendMessageRequest := _PostSendMessageRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPostSendMessageRequest)

	if err != nil {
		return err
	}

	*o = PostSendMessageRequest(varPostSendMessageRequest)

	return err
}

type NullablePostSendMessageRequest struct {
	value *PostSendMessageRequest
	isSet bool
}

func (v NullablePostSendMessageRequest) Get() *PostSendMessageRequest {
	return v.value
}

func (v *NullablePostSendMessageRequest) Set(val *PostSendMessageRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostSendMessageRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostSendMessageRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostSendMessageRequest(val *PostSendMessageRequest) *NullablePostSendMessageRequest {
	return &NullablePostSendMessageRequest{value: val, isSet: true}
}

func (v NullablePostSendMessageRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostSendMessageRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
