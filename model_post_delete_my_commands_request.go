...
// checks if the PostDeleteMyCommandsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostDeleteMyCommandsRequest{}

// PostDeleteMyCommandsRequest struct for PostDeleteMyCommandsRequest
type PostDeleteMyCommandsRequest struct {
...
func NewPostDeleteMyCommandsRequest() *PostDeleteMyCommandsRequest {
	this := PostDeleteMyCommandsRequest{}
	return &this
}
...
func (o PostDeleteMyCommandsRequest) MarshalJSON() ([]byte, error) {
...
func (o PostDeleteMyCommandsRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePostDeleteMyCommandsRequest struct {
	value *PostDeleteMyCommandsRequest
	isSet bool
}

func (v NullablePostDeleteMyCommandsRequest) Get() *PostDeleteMyCommandsRequest {
	return v.value
}

func (v *NullablePostDeleteMyCommandsRequest) Set(val *PostDeleteMyCommandsRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostDeleteMyCommandsRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostDeleteMyCommandsRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostDeleteMyCommandsRequest(val *PostDeleteMyCommandsRequest) *NullablePostDeleteMyCommandsRequest {
	return &NullablePostDeleteMyCommandsRequest{value: val, isSet: true}
}

func (v NullablePostDeleteMyCommandsRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostDeleteMyCommandsRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
