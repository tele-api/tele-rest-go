...
// checks if the AnswerInlineQueryRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AnswerInlineQueryRequest{}

// AnswerInlineQueryRequest Request parameters for answerInlineQuery
...
type _AnswerInlineQueryRequest AnswerInlineQueryRequest
...
func (o AnswerInlineQueryRequest) MarshalJSON() ([]byte, error) {
...
func (o AnswerInlineQueryRequest) ToMap() (map[string]interface{}, error) {
...
func (o *AnswerInlineQueryRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varAnswerInlineQueryRequest := _AnswerInlineQueryRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAnswerInlineQueryRequest)

	if err != nil {
		return err
	}

	*o = AnswerInlineQueryRequest(varAnswerInlineQueryRequest)

	return err
}

type NullableAnswerInlineQueryRequest struct {
	value *AnswerInlineQueryRequest
	isSet bool
}

func (v NullableAnswerInlineQueryRequest) Get() *AnswerInlineQueryRequest {
	return v.value
}

func (v *NullableAnswerInlineQueryRequest) Set(val *AnswerInlineQueryRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableAnswerInlineQueryRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableAnswerInlineQueryRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAnswerInlineQueryRequest(val *AnswerInlineQueryRequest) *NullableAnswerInlineQueryRequest {
	return &NullableAnswerInlineQueryRequest{value: val, isSet: true}
}

func (v NullableAnswerInlineQueryRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAnswerInlineQueryRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
