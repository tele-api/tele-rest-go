...
// checks if the GetUpdatesRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetUpdatesRequest{}

// GetUpdatesRequest Request parameters for getUpdates
...
func (o GetUpdatesRequest) MarshalJSON() ([]byte, error) {
...
func (o GetUpdatesRequest) ToMap() (map[string]interface{}, error) {
...
type NullableGetUpdatesRequest struct {
	value *GetUpdatesRequest
	isSet bool
}

func (v NullableGetUpdatesRequest) Get() *GetUpdatesRequest {
	return v.value
}

func (v *NullableGetUpdatesRequest) Set(val *GetUpdatesRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableGetUpdatesRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableGetUpdatesRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetUpdatesRequest(val *GetUpdatesRequest) *NullableGetUpdatesRequest {
	return &NullableGetUpdatesRequest{value: val, isSet: true}
}

func (v NullableGetUpdatesRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetUpdatesRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
