...
// checks if the PostGetMyCommandsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostGetMyCommandsRequest{}

// PostGetMyCommandsRequest struct for PostGetMyCommandsRequest
type PostGetMyCommandsRequest struct {
...
func (o PostGetMyCommandsRequest) MarshalJSON() ([]byte, error) {
...
func (o PostGetMyCommandsRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePostGetMyCommandsRequest struct {
	value *PostGetMyCommandsRequest
	isSet bool
}

func (v NullablePostGetMyCommandsRequest) Get() *PostGetMyCommandsRequest {
	return v.value
}

func (v *NullablePostGetMyCommandsRequest) Set(val *PostGetMyCommandsRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostGetMyCommandsRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostGetMyCommandsRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostGetMyCommandsRequest(val *PostGetMyCommandsRequest) *NullablePostGetMyCommandsRequest {
	return &NullablePostGetMyCommandsRequest{value: val, isSet: true}
}

func (v NullablePostGetMyCommandsRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostGetMyCommandsRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
