...
// checks if the SendLocationPostRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SendLocationPostRequest{}

// SendLocationPostRequest struct for SendLocationPostRequest
type SendLocationPostRequest struct {
...
type _SendLocationPostRequest SendLocationPostRequest
...
func (o SendLocationPostRequest) MarshalJSON() ([]byte, error) {
...
func (o SendLocationPostRequest) ToMap() (map[string]interface{}, error) {
...
func (o *SendLocationPostRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varSendLocationPostRequest := _SendLocationPostRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSendLocationPostRequest)

	if err != nil {
		return err
	}

	*o = SendLocationPostRequest(varSendLocationPostRequest)

	return err
}

type NullableSendLocationPostRequest struct {
	value *SendLocationPostRequest
	isSet bool
}

func (v NullableSendLocationPostRequest) Get() *SendLocationPostRequest {
	return v.value
}

func (v *NullableSendLocationPostRequest) Set(val *SendLocationPostRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableSendLocationPostRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableSendLocationPostRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSendLocationPostRequest(val *SendLocationPostRequest) *NullableSendLocationPostRequest {
	return &NullableSendLocationPostRequest{value: val, isSet: true}
}

func (v NullableSendLocationPostRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSendLocationPostRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
