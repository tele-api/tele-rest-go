...
// checks if the PostGiftPremiumSubscriptionRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostGiftPremiumSubscriptionRequest{}

// PostGiftPremiumSubscriptionRequest struct for PostGiftPremiumSubscriptionRequest
type PostGiftPremiumSubscriptionRequest struct {
...
type _PostGiftPremiumSubscriptionRequest PostGiftPremiumSubscriptionRequest
...
func NewPostGiftPremiumSubscriptionRequest(userId int32, monthCount int32, starCount int32) *PostGiftPremiumSubscriptionRequest {
	this := PostGiftPremiumSubscriptionRequest{}
	this.UserId = userId
...
func (o PostGiftPremiumSubscriptionRequest) MarshalJSON() ([]byte, error) {
...
func (o PostGiftPremiumSubscriptionRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PostGiftPremiumSubscriptionRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPostGiftPremiumSubscriptionRequest := _PostGiftPremiumSubscriptionRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPostGiftPremiumSubscriptionRequest)

	if err != nil {
		return err
	}

	*o = PostGiftPremiumSubscriptionRequest(varPostGiftPremiumSubscriptionRequest)

	return err
}

type NullablePostGiftPremiumSubscriptionRequest struct {
	value *PostGiftPremiumSubscriptionRequest
	isSet bool
}

func (v NullablePostGiftPremiumSubscriptionRequest) Get() *PostGiftPremiumSubscriptionRequest {
	return v.value
}

func (v *NullablePostGiftPremiumSubscriptionRequest) Set(val *PostGiftPremiumSubscriptionRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostGiftPremiumSubscriptionRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostGiftPremiumSubscriptionRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostGiftPremiumSubscriptionRequest(val *PostGiftPremiumSubscriptionRequest) *NullablePostGiftPremiumSubscriptionRequest {
	return &NullablePostGiftPremiumSubscriptionRequest{value: val, isSet: true}
}

func (v NullablePostGiftPremiumSubscriptionRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostGiftPremiumSubscriptionRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
