...
// checks if the PostSetChatMenuButtonRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostSetChatMenuButtonRequest{}

// PostSetChatMenuButtonRequest struct for PostSetChatMenuButtonRequest
type PostSetChatMenuButtonRequest struct {
...
func NewPostSetChatMenuButtonRequest() *PostSetChatMenuButtonRequest {
	this := PostSetChatMenuButtonRequest{}
	return &this
}
...
func (o PostSetChatMenuButtonRequest) MarshalJSON() ([]byte, error) {
...
func (o PostSetChatMenuButtonRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePostSetChatMenuButtonRequest struct {
	value *PostSetChatMenuButtonRequest
	isSet bool
}

func (v NullablePostSetChatMenuButtonRequest) Get() *PostSetChatMenuButtonRequest {
	return v.value
}

func (v *NullablePostSetChatMenuButtonRequest) Set(val *PostSetChatMenuButtonRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostSetChatMenuButtonRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostSetChatMenuButtonRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostSetChatMenuButtonRequest(val *PostSetChatMenuButtonRequest) *NullablePostSetChatMenuButtonRequest {
	return &NullablePostSetChatMenuButtonRequest{value: val, isSet: true}
}

func (v NullablePostSetChatMenuButtonRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostSetChatMenuButtonRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
