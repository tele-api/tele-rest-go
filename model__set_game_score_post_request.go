...
// checks if the SetGameScorePostRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SetGameScorePostRequest{}

// SetGameScorePostRequest struct for SetGameScorePostRequest
type SetGameScorePostRequest struct {
	// User identifier
...
type _SetGameScorePostRequest SetGameScorePostRequest
...
func (o SetGameScorePostRequest) MarshalJSON() ([]byte, error) {
...
func (o SetGameScorePostRequest) ToMap() (map[string]interface{}, error) {
...
func (o *SetGameScorePostRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varSetGameScorePostRequest := _SetGameScorePostRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSetGameScorePostRequest)

	if err != nil {
		return err
	}

	*o = SetGameScorePostRequest(varSetGameScorePostRequest)

	return err
}

type NullableSetGameScorePostRequest struct {
	value *SetGameScorePostRequest
	isSet bool
}

func (v NullableSetGameScorePostRequest) Get() *SetGameScorePostRequest {
	return v.value
}

func (v *NullableSetGameScorePostRequest) Set(val *SetGameScorePostRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableSetGameScorePostRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableSetGameScorePostRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSetGameScorePostRequest(val *SetGameScorePostRequest) *NullableSetGameScorePostRequest {
	return &NullableSetGameScorePostRequest{value: val, isSet: true}
}

func (v NullableSetGameScorePostRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSetGameScorePostRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
