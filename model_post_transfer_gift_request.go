...
// checks if the PostTransferGiftRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostTransferGiftRequest{}

// PostTransferGiftRequest struct for PostTransferGiftRequest
type PostTransferGiftRequest struct {
...
type _PostTransferGiftRequest PostTransferGiftRequest
...
func (o PostTransferGiftRequest) MarshalJSON() ([]byte, error) {
...
func (o PostTransferGiftRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PostTransferGiftRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPostTransferGiftRequest := _PostTransferGiftRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPostTransferGiftRequest)

	if err != nil {
		return err
	}

	*o = PostTransferGiftRequest(varPostTransferGiftRequest)

	return err
}

type NullablePostTransferGiftRequest struct {
	value *PostTransferGiftRequest
	isSet bool
}

func (v NullablePostTransferGiftRequest) Get() *PostTransferGiftRequest {
	return v.value
}

func (v *NullablePostTransferGiftRequest) Set(val *PostTransferGiftRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostTransferGiftRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostTransferGiftRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostTransferGiftRequest(val *PostTransferGiftRequest) *NullablePostTransferGiftRequest {
	return &NullablePostTransferGiftRequest{value: val, isSet: true}
}

func (v NullablePostTransferGiftRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostTransferGiftRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
