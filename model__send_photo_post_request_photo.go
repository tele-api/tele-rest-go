...
func (src SendPhotoPostRequestPhoto) MarshalJSON() ([]byte, error) {
	if src.Any != nil {
...
func (v NullableSendPhotoPostRequestPhoto) Get() *SendPhotoPostRequestPhoto {
	return v.value
}

func (v *NullableSendPhotoPostRequestPhoto) Set(val *SendPhotoPostRequestPhoto) {
	v.value = val
	v.isSet = true
}

func (v NullableSendPhotoPostRequestPhoto) IsSet() bool {
	return v.isSet
}

func (v *NullableSendPhotoPostRequestPhoto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSendPhotoPostRequestPhoto(val *SendPhotoPostRequestPhoto) *NullableSendPhotoPostRequestPhoto {
	return &NullableSendPhotoPostRequestPhoto{value: val, isSet: true}
}

func (v NullableSendPhotoPostRequestPhoto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSendPhotoPostRequestPhoto) UnmarshalJSON(src []byte) error {
	v.isSet = true
