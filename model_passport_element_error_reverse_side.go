...
// checks if the PassportElementErrorReverseSide type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PassportElementErrorReverseSide{}
...
type _PassportElementErrorReverseSide PassportElementErrorReverseSide
...
func NewPassportElementErrorReverseSide(source string, type_ string, fileHash string, message string) *PassportElementErrorReverseSide {
	this := PassportElementErrorReverseSide{}
	this.Source = source
	this.Type = type_
...
func NewPassportElementErrorReverseSideWithDefaults() *PassportElementErrorReverseSide {
	this := PassportElementErrorReverseSide{}
	var source string = "reverse_side"
	this.Source = source
	return &this
}
...
func (o PassportElementErrorReverseSide) ToMap() (map[string]interface{}, error) {
...
func (o *PassportElementErrorReverseSide) UnmarshalJSON(data []byte) (err error) {
	...
	varPassportElementErrorReverseSide := _PassportElementErrorReverseSide{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPassportElementErrorReverseSide)

	if err != nil {
		return err
	}

	*o = PassportElementErrorReverseSide(varPassportElementErrorReverseSide)

	return err
}

type NullablePassportElementErrorReverseSide struct {
	value *PassportElementErrorReverseSide
	isSet bool
}

func (v NullablePassportElementErrorReverseSide) Get() *PassportElementErrorReverseSide {
	return v.value
}

func (v *NullablePassportElementErrorReverseSide) Set(val *PassportElementErrorReverseSide) {
	v.value = val
	v.isSet = true
}

func (v NullablePassportElementErrorReverseSide) IsSet() bool {
	return v.isSet
}

func (v *NullablePassportElementErrorReverseSide) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePassportElementErrorReverseSide(val *PassportElementErrorReverseSide) *NullablePassportElementErrorReverseSide {
	return &NullablePassportElementErrorReverseSide{value: val, isSet: true}
}

func (v NullablePassportElementErrorReverseSide) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePassportElementErrorReverseSide) UnmarshalJSON(src []byte) error {
	v.isSet = true
