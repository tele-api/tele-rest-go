...
// GetStartParameter returns the StartParameter field value
...
// GetStartParameterOk returns a tuple with the StartParameter field value
// and a boolean to check if the value has been set.
...
// SetStartParameter sets field value
