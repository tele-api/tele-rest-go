...
// checks if the InlineQueryResultGame type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InlineQueryResultGame{}
...
type _InlineQueryResultGame InlineQueryResultGame
...
func (o InlineQueryResultGame) ToMap() (map[string]interface{}, error) {
...
func (o *InlineQueryResultGame) UnmarshalJSON(data []byte) (err error) {
	...
	varInlineQueryResultGame := _InlineQueryResultGame{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varInlineQueryResultGame)

	if err != nil {
		return err
	}

	*o = InlineQueryResultGame(varInlineQueryResultGame)

	return err
}

type NullableInlineQueryResultGame struct {
	value *InlineQueryResultGame
	isSet bool
}

func (v NullableInlineQueryResultGame) Get() *InlineQueryResultGame {
	return v.value
}

func (v *NullableInlineQueryResultGame) Set(val *InlineQueryResultGame) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineQueryResultGame) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineQueryResultGame) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineQueryResultGame(val *InlineQueryResultGame) *NullableInlineQueryResultGame {
	return &NullableInlineQueryResultGame{value: val, isSet: true}
}

func (v NullableInlineQueryResultGame) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineQueryResultGame) UnmarshalJSON(src []byte) error {
	v.isSet = true
