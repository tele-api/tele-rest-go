...
// checks if the PostCreateForumTopicRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostCreateForumTopicRequest{}

// PostCreateForumTopicRequest struct for PostCreateForumTopicRequest
type PostCreateForumTopicRequest struct {
...
type _PostCreateForumTopicRequest PostCreateForumTopicRequest
...
func NewPostCreateForumTopicRequest(chatId PostRestrictChatMemberRequestChatId, name string) *PostCreateForumTopicRequest {
	this := PostCreateForumTopicRequest{}
	this.ChatId = chatId
	this.Name = name
	return &this
}
...
func (o PostCreateForumTopicRequest) MarshalJSON() ([]byte, error) {
...
func (o PostCreateForumTopicRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PostCreateForumTopicRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPostCreateForumTopicRequest := _PostCreateForumTopicRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPostCreateForumTopicRequest)

	if err != nil {
		return err
	}

	*o = PostCreateForumTopicRequest(varPostCreateForumTopicRequest)

	return err
}

type NullablePostCreateForumTopicRequest struct {
	value *PostCreateForumTopicRequest
	isSet bool
}

func (v NullablePostCreateForumTopicRequest) Get() *PostCreateForumTopicRequest {
	return v.value
}

func (v *NullablePostCreateForumTopicRequest) Set(val *PostCreateForumTopicRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostCreateForumTopicRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostCreateForumTopicRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostCreateForumTopicRequest(val *PostCreateForumTopicRequest) *NullablePostCreateForumTopicRequest {
	return &NullablePostCreateForumTopicRequest{value: val, isSet: true}
}

func (v NullablePostCreateForumTopicRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostCreateForumTopicRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
